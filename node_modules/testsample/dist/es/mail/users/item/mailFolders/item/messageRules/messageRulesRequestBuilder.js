...
export class MessageRulesRequestBuilder {
    ...
    get(q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, MessageRulesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
    /**
     * The collection of rules that apply to the user's Inbox folder.
    ...
    post(body, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, MessageRule, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
}
