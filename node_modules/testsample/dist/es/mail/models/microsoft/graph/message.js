...
export class Message extends OutlookItem {
    ...
    getFieldDeserializers() {
        return new Map([...super.getFieldDeserializers(),
            ["attachments", (o, n) => { o.attachments = n.getCollectionOfObjectValues(Attachment); }],
            ["bccRecipients", (o, n) => { o.bccRecipients = n.getCollectionOfObjectValues(Recipient); }],
            ["body", (o, n) => { o.body = n.getObjectValue(ItemBody); }],
            ["bodyPreview", (o, n) => { o.bodyPreview = n.getStringValue(); }],
            ["ccRecipients", (o, n) => { o.ccRecipients = n.getCollectionOfObjectValues(Recipient); }],
            ["conversationId", (o, n) => { o.conversationId = n.getStringValue(); }],
            ["conversationIndex", (o, n) => { o.conversationIndex = n.getStringValue(); }],
            ["extensions", (o, n) => { o.extensions = n.getCollectionOfObjectValues(Extension); }],
            ...
            ["internetMessageHeaders", (o, n) => { o.internetMessageHeaders = n.getCollectionOfObjectValues(InternetMessageHeader); }],
            ...
            ["multiValueExtendedProperties", (o, n) => { o.multiValueExtendedProperties = n.getCollectionOfObjectValues(MultiValueLegacyExtendedProperty); }],
            ["parentFolderId", (o, n) => { o.parentFolderId = n.getStringValue(); }],
            ["receivedDateTime", (o, n) => { o.receivedDateTime = n.getDateValue(); }],
            ["replyTo", (o, n) => { o.replyTo = n.getCollectionOfObjectValues(Recipient); }],
            ["sender", (o, n) => { o.sender = n.getObjectValue(Recipient); }],
            ["sentDateTime", (o, n) => { o.sentDateTime = n.getDateValue(); }],
            ["singleValueExtendedProperties", (o, n) => { o.singleValueExtendedProperties = n.getCollectionOfObjectValues(SingleValueLegacyExtendedProperty); }],
            ["subject", (o, n) => { o.subject = n.getStringValue(); }],
            ["toRecipients", (o, n) => { o.toRecipients = n.getCollectionOfObjectValues(Recipient); }],
