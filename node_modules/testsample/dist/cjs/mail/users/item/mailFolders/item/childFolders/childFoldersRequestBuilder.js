...
const childFoldersResponse_1 = require("./childFoldersResponse");
...
class ChildFoldersRequestBuilder {
    ...
    get(q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, childFoldersResponse_1.ChildFoldersResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
    /**
     * The collection of child folders in the mailFolder.
