...
import {CreateWithListRequestBuilderPostRequestConfiguration} from './createWithListRequestBuilderPostRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/** Builds and executes requests for operations under /user/createWithList */
export class CreateWithListRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: User[] | undefined, requestConfiguration?: CreateWithListRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
     ...
     */
    public post(body: User[] | undefined, requestConfiguration?: CreateWithListRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<User | undefined> {
        if(!body) throw new Error("body cannot be undefined");
