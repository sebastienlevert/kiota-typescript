...
import {deserializeIntoApplicationTemplate} from '../models/deserializeIntoApplicationTemplate';
import {deserializeIntoApplicationTemplateCollectionResponse} from '../models/deserializeIntoApplicationTemplateCollectionResponse';
import {ODataError} from '../models/oDataErrors/oDataError';
import {serializeApplicationTemplate} from '../models/serializeApplicationTemplate';
import {serializeApplicationTemplateCollectionResponse} from '../models/serializeApplicationTemplateCollectionResponse';
...
export class ApplicationTemplatesRequestBuilder {
    ...
    public createPostRequestInformation(body: ApplicationTemplate | undefined, requestConfiguration?: ApplicationTemplatesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeApplicationTemplate);
        return requestInfo;
    };
    /**
     * Retrieve a list of applicationTemplate objects from the Azure AD application gallery.
    ...
    public get(requestConfiguration?: ApplicationTemplatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationTemplateCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApplicationTemplateCollectionResponse>(requestInfo,deserializeIntoApplicationTemplateCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Add new entity to applicationTemplates
     * @param body 
    ...
    public post(body: ApplicationTemplate | undefined, requestConfiguration?: ApplicationTemplatesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApplicationTemplate | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApplicationTemplate>(requestInfo,deserializeIntoApplicationTemplate, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
