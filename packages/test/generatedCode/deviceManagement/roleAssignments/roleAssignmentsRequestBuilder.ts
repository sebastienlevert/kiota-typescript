...
import {deserializeIntoDeviceAndAppManagementRoleAssignmentCollectionResponse} from '../../models/deserializeIntoDeviceAndAppManagementRoleAssignmentCollectionResponse';
...
import {serializeDeviceAndAppManagementRoleAssignmentCollectionResponse} from '../../models/serializeDeviceAndAppManagementRoleAssignmentCollectionResponse';
...
export class RoleAssignmentsRequestBuilder {
    ...
    public get(requestConfiguration?: RoleAssignmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceAndAppManagementRoleAssignmentCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceAndAppManagementRoleAssignmentCollectionResponse>(requestInfo,deserializeIntoDeviceAndAppManagementRoleAssignmentCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to roleAssignments for deviceManagement
     * @param body 
    ...
    public post(body: DeviceAndAppManagementRoleAssignment | undefined, requestConfiguration?: RoleAssignmentsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceAndAppManagementRoleAssignment | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceAndAppManagementRoleAssignment>(requestInfo,deserializeIntoDeviceAndAppManagementRoleAssignment, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
