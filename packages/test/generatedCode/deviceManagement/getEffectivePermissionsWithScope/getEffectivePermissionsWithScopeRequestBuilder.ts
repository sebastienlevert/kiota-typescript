...
import {serializeGetEffectivePermissionsWithScopeResponse} from './serializeGetEffectivePermissionsWithScopeResponse';
...
export class GetEffectivePermissionsWithScopeRequestBuilder {
    ...
    public get(requestConfiguration?: GetEffectivePermissionsWithScopeRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetEffectivePermissionsWithScopeResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetEffectivePermissionsWithScopeResponse>(requestInfo,deserializeIntoGetEffectivePermissionsWithScopeResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
