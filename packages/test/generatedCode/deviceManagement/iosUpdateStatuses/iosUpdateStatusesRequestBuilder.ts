...
import {deserializeIntoIosUpdateDeviceStatusCollectionResponse} from '../../models/deserializeIntoIosUpdateDeviceStatusCollectionResponse';
...
import {serializeIosUpdateDeviceStatusCollectionResponse} from '../../models/serializeIosUpdateDeviceStatusCollectionResponse';
...
export class IosUpdateStatusesRequestBuilder {
    ...
    public get(requestConfiguration?: IosUpdateStatusesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IosUpdateDeviceStatusCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<IosUpdateDeviceStatusCollectionResponse>(requestInfo,deserializeIntoIosUpdateDeviceStatusCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to iosUpdateStatuses for deviceManagement
     * @param body 
