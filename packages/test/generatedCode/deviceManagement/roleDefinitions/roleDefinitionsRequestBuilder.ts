...
import {deserializeIntoRoleDefinitionCollectionResponse} from '../../models/deserializeIntoRoleDefinitionCollectionResponse';
...
import {serializeRoleDefinitionCollectionResponse} from '../../models/serializeRoleDefinitionCollectionResponse';
...
export class RoleDefinitionsRequestBuilder {
    ...
    public get(requestConfiguration?: RoleDefinitionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RoleDefinitionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RoleDefinitionCollectionResponse>(requestInfo,deserializeIntoRoleDefinitionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to roleDefinitions for deviceManagement
     * @param body 
