...
import {serializeDownloadApplePushNotificationCertificateSigningRequestResponse} from './serializeDownloadApplePushNotificationCertificateSigningRequestResponse';
...
export class DownloadApplePushNotificationCertificateSigningRequestRequestBuilder {
    ...
    public get(requestConfiguration?: DownloadApplePushNotificationCertificateSigningRequestRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DownloadApplePushNotificationCertificateSigningRequestResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DownloadApplePushNotificationCertificateSigningRequestResponse>(requestInfo,deserializeIntoDownloadApplePushNotificationCertificateSigningRequestResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
