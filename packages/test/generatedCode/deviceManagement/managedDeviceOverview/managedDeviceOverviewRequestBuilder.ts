import {deserializeIntoManagedDeviceOverview} from '../../models/deserializeIntoManagedDeviceOverview';
import {ManagedDeviceOverview} from '../../models/managedDeviceOverview';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeManagedDeviceOverview} from '../../models/serializeManagedDeviceOverview';
...
export class ManagedDeviceOverviewRequestBuilder {
    ...
    public get(requestConfiguration?: ManagedDeviceOverviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedDeviceOverview | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ManagedDeviceOverview>(requestInfo,deserializeIntoManagedDeviceOverview, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
