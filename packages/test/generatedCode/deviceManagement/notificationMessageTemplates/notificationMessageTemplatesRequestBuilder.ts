...
import {deserializeIntoNotificationMessageTemplateCollectionResponse} from '../../models/deserializeIntoNotificationMessageTemplateCollectionResponse';
...
import {serializeNotificationMessageTemplateCollectionResponse} from '../../models/serializeNotificationMessageTemplateCollectionResponse';
...
export class NotificationMessageTemplatesRequestBuilder {
    ...
    public get(requestConfiguration?: NotificationMessageTemplatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<NotificationMessageTemplateCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<NotificationMessageTemplateCollectionResponse>(requestInfo,deserializeIntoNotificationMessageTemplateCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to notificationMessageTemplates for deviceManagement
     * @param body 
    ...
    public post(body: NotificationMessageTemplate | undefined, requestConfiguration?: NotificationMessageTemplatesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<NotificationMessageTemplate | undefined> {
        ...
        return this.requestAdapter?.sendAsync<NotificationMessageTemplate>(requestInfo,deserializeIntoNotificationMessageTemplate, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
