...
import {serializeGetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse} from './serializeGetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse';
...
export class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder {
    ...
    public get(requestConfiguration?: GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse>(requestInfo,deserializeIntoGetOmaSettingPlainTextValueWithSecretReferenceValueIdResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
