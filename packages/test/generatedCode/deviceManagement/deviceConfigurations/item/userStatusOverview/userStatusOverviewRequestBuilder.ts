...
export class UserStatusOverviewRequestBuilder {
    ...
    public get(requestConfiguration?: UserStatusOverviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceConfigurationUserOverview | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceConfigurationUserOverview>(requestInfo,deserializeIntoDeviceConfigurationUserOverview, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the navigation property userStatusOverview in deviceManagement
     * @param body 
