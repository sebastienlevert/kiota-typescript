...
import {deserializeIntoDeviceConfigurationDeviceStatusCollectionResponse} from '../../../../models/deserializeIntoDeviceConfigurationDeviceStatusCollectionResponse';
...
import {serializeDeviceConfigurationDeviceStatusCollectionResponse} from '../../../../models/serializeDeviceConfigurationDeviceStatusCollectionResponse';
...
export class DeviceStatusesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceStatusesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceConfigurationDeviceStatusCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceConfigurationDeviceStatusCollectionResponse>(requestInfo,deserializeIntoDeviceConfigurationDeviceStatusCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceStatuses for deviceManagement
     * @param body 
