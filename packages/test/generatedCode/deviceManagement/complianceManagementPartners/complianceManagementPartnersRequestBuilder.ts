...
import {deserializeIntoComplianceManagementPartnerCollectionResponse} from '../../models/deserializeIntoComplianceManagementPartnerCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeComplianceManagementPartner} from '../../models/serializeComplianceManagementPartner';
import {serializeComplianceManagementPartnerCollectionResponse} from '../../models/serializeComplianceManagementPartnerCollectionResponse';
...
export class ComplianceManagementPartnersRequestBuilder {
    ...
    public get(requestConfiguration?: ComplianceManagementPartnersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ComplianceManagementPartnerCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ComplianceManagementPartnerCollectionResponse>(requestInfo,deserializeIntoComplianceManagementPartnerCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to complianceManagementPartners for deviceManagement
     * @param body 
