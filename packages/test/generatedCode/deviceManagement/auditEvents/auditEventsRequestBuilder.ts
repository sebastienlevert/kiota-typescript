...
import {AuditEventCollectionResponse} from '../../models/auditEventCollectionResponse';
import {deserializeIntoAuditEvent} from '../../models/deserializeIntoAuditEvent';
import {deserializeIntoAuditEventCollectionResponse} from '../../models/deserializeIntoAuditEventCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeAuditEvent} from '../../models/serializeAuditEvent';
import {serializeAuditEventCollectionResponse} from '../../models/serializeAuditEventCollectionResponse';
...
export class AuditEventsRequestBuilder {
    ...
    public get(requestConfiguration?: AuditEventsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuditEventCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AuditEventCollectionResponse>(requestInfo,deserializeIntoAuditEventCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
