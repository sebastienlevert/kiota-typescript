...
import {serializeGetAuditActivityTypesWithCategoryResponse} from './serializeGetAuditActivityTypesWithCategoryResponse';
...
export class GetAuditActivityTypesWithCategoryRequestBuilder {
    ...
    public get(requestConfiguration?: GetAuditActivityTypesWithCategoryRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetAuditActivityTypesWithCategoryResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetAuditActivityTypesWithCategoryResponse>(requestInfo,deserializeIntoGetAuditActivityTypesWithCategoryResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
