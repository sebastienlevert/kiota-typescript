...
import {serializeVerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse} from './serializeVerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse';
...
export class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder {
    ...
    public get(requestConfiguration?: VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse>(requestInfo,deserializeIntoVerifyWindowsEnrollmentAutoDiscoveryWithDomainNameResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
