...
import {deserializeIntoEnrollmentConfigurationAssignmentCollectionResponse} from '../../../../models/deserializeIntoEnrollmentConfigurationAssignmentCollectionResponse';
...
import {serializeEnrollmentConfigurationAssignmentCollectionResponse} from '../../../../models/serializeEnrollmentConfigurationAssignmentCollectionResponse';
...
export class AssignmentsRequestBuilder {
    ...
    public get(requestConfiguration?: AssignmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EnrollmentConfigurationAssignmentCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EnrollmentConfigurationAssignmentCollectionResponse>(requestInfo,deserializeIntoEnrollmentConfigurationAssignmentCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to assignments for deviceManagement
     * @param body 
