...
export class ConditionalAccessSettingsRequestBuilder {
    ...
    public get(requestConfiguration?: ConditionalAccessSettingsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnPremisesConditionalAccessSettings | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OnPremisesConditionalAccessSettings>(requestInfo,deserializeIntoOnPremisesConditionalAccessSettings, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the navigation property conditionalAccessSettings in deviceManagement
     * @param body 
