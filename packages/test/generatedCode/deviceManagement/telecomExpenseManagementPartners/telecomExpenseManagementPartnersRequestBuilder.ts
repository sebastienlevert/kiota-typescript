...
import {deserializeIntoTelecomExpenseManagementPartnerCollectionResponse} from '../../models/deserializeIntoTelecomExpenseManagementPartnerCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeTelecomExpenseManagementPartner} from '../../models/serializeTelecomExpenseManagementPartner';
import {serializeTelecomExpenseManagementPartnerCollectionResponse} from '../../models/serializeTelecomExpenseManagementPartnerCollectionResponse';
...
export class TelecomExpenseManagementPartnersRequestBuilder {
    ...
    public get(requestConfiguration?: TelecomExpenseManagementPartnersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TelecomExpenseManagementPartnerCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TelecomExpenseManagementPartnerCollectionResponse>(requestInfo,deserializeIntoTelecomExpenseManagementPartnerCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to telecomExpenseManagementPartners for deviceManagement
     * @param body 
    ...
    public post(body: TelecomExpenseManagementPartner | undefined, requestConfiguration?: TelecomExpenseManagementPartnersRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TelecomExpenseManagementPartner | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TelecomExpenseManagementPartner>(requestInfo,deserializeIntoTelecomExpenseManagementPartner, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
