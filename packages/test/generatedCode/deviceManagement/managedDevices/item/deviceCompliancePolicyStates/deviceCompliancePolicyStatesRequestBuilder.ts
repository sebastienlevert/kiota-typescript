...
import {deserializeIntoDeviceCompliancePolicyStateCollectionResponse} from '../../../../models/deserializeIntoDeviceCompliancePolicyStateCollectionResponse';
...
import {serializeDeviceCompliancePolicyStateCollectionResponse} from '../../../../models/serializeDeviceCompliancePolicyStateCollectionResponse';
...
export class DeviceCompliancePolicyStatesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceCompliancePolicyStatesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceCompliancePolicyStateCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceCompliancePolicyStateCollectionResponse>(requestInfo,deserializeIntoDeviceCompliancePolicyStateCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceCompliancePolicyStates for deviceManagement
     * @param body 
