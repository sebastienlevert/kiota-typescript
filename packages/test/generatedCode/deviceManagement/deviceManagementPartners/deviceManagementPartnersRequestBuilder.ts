...
import {deserializeIntoDeviceManagementPartnerCollectionResponse} from '../../models/deserializeIntoDeviceManagementPartnerCollectionResponse';
...
import {serializeDeviceManagementPartnerCollectionResponse} from '../../models/serializeDeviceManagementPartnerCollectionResponse';
...
export class DeviceManagementPartnersRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceManagementPartnersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceManagementPartnerCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceManagementPartnerCollectionResponse>(requestInfo,deserializeIntoDeviceManagementPartnerCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceManagementPartners for deviceManagement
     * @param body 
    ...
    public post(body: DeviceManagementPartner | undefined, requestConfiguration?: DeviceManagementPartnersRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceManagementPartner | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceManagementPartner>(requestInfo,deserializeIntoDeviceManagementPartner, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
