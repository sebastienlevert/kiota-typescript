...
import {deserializeIntoDeviceCompliancePolicyCollectionResponse} from '../../models/deserializeIntoDeviceCompliancePolicyCollectionResponse';
...
import {serializeDeviceCompliancePolicyCollectionResponse} from '../../models/serializeDeviceCompliancePolicyCollectionResponse';
...
export class DeviceCompliancePoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceCompliancePoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceCompliancePolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceCompliancePolicyCollectionResponse>(requestInfo,deserializeIntoDeviceCompliancePolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceCompliancePolicies for deviceManagement
     * @param body 
