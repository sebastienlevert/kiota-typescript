...
import {deserializeIntoDeviceComplianceDeviceStatusCollectionResponse} from '../../../../models/deserializeIntoDeviceComplianceDeviceStatusCollectionResponse';
...
import {serializeDeviceComplianceDeviceStatusCollectionResponse} from '../../../../models/serializeDeviceComplianceDeviceStatusCollectionResponse';
...
export class DeviceStatusesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceStatusesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceDeviceStatusCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceDeviceStatusCollectionResponse>(requestInfo,deserializeIntoDeviceComplianceDeviceStatusCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceStatuses for deviceManagement
     * @param body 
    ...
    public post(body: DeviceComplianceDeviceStatus | undefined, requestConfiguration?: DeviceStatusesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceDeviceStatus | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceDeviceStatus>(requestInfo,deserializeIntoDeviceComplianceDeviceStatus, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
