...
import {deserializeIntoDeviceComplianceScheduledActionForRuleCollectionResponse} from '../../../../models/deserializeIntoDeviceComplianceScheduledActionForRuleCollectionResponse';
...
import {serializeDeviceComplianceScheduledActionForRuleCollectionResponse} from '../../../../models/serializeDeviceComplianceScheduledActionForRuleCollectionResponse';
...
export class ScheduledActionsForRuleRequestBuilder {
    ...
    public get(requestConfiguration?: ScheduledActionsForRuleRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DeviceComplianceScheduledActionForRuleCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DeviceComplianceScheduledActionForRuleCollectionResponse>(requestInfo,deserializeIntoDeviceComplianceScheduledActionForRuleCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to scheduledActionsForRule for deviceManagement
     * @param body 
