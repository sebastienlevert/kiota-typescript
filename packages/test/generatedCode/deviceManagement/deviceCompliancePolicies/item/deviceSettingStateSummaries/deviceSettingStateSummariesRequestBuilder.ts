...
import {deserializeIntoSettingStateDeviceSummaryCollectionResponse} from '../../../../models/deserializeIntoSettingStateDeviceSummaryCollectionResponse';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeSettingStateDeviceSummary} from '../../../../models/serializeSettingStateDeviceSummary';
import {serializeSettingStateDeviceSummaryCollectionResponse} from '../../../../models/serializeSettingStateDeviceSummaryCollectionResponse';
...
export class DeviceSettingStateSummariesRequestBuilder {
    ...
    public get(requestConfiguration?: DeviceSettingStateSummariesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SettingStateDeviceSummaryCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SettingStateDeviceSummaryCollectionResponse>(requestInfo,deserializeIntoSettingStateDeviceSummaryCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to deviceSettingStateSummaries for deviceManagement
     * @param body 
    ...
    public post(body: SettingStateDeviceSummary | undefined, requestConfiguration?: DeviceSettingStateSummariesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SettingStateDeviceSummary | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SettingStateDeviceSummary>(requestInfo,deserializeIntoSettingStateDeviceSummary, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
