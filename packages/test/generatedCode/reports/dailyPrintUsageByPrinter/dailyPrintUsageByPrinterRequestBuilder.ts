...
import {deserializeIntoPrintUsageByPrinterCollectionResponse} from '../../models/deserializeIntoPrintUsageByPrinterCollectionResponse';
...
import {serializePrintUsageByPrinterCollectionResponse} from '../../models/serializePrintUsageByPrinterCollectionResponse';
...
export class DailyPrintUsageByPrinterRequestBuilder {
    ...
    public get(requestConfiguration?: DailyPrintUsageByPrinterRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PrintUsageByPrinterCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PrintUsageByPrinterCollectionResponse>(requestInfo,deserializeIntoPrintUsageByPrinterCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to dailyPrintUsageByPrinter for reports
     * @param body 
    ...
    public post(body: PrintUsageByPrinter | undefined, requestConfiguration?: DailyPrintUsageByPrinterRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PrintUsageByPrinter | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PrintUsageByPrinter>(requestInfo,deserializeIntoPrintUsageByPrinter, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
