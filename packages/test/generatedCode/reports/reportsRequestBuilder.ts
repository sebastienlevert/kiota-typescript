...
import {PrintUsageByPrinterItemRequestBuilder as i999f934e366eb591b3ee866ea634bcf91706140d924598be6fc20d94119758a7} from './dailyPrintUsageByPrinter/item/printUsageByPrinterItemRequestBuilder';
import {DailyPrintUsageByUserRequestBuilder} from './dailyPrintUsageByUser/dailyPrintUsageByUserRequestBuilder';
import {PrintUsageByUserItemRequestBuilder as ib4d89d616f0f9478489dad3d7dc4326f7419ae7b40bc6ddf346d0c49d382b870} from './dailyPrintUsageByUser/item/printUsageByUserItemRequestBuilder';
...
import {PrintUsageByPrinterItemRequestBuilder as i92d55dadeb2b9bd47045870472c2cf7fc0ff25deda0749b050d8e77bb5ec9bbe} from './monthlyPrintUsageByPrinter/item/printUsageByPrinterItemRequestBuilder';
import {MonthlyPrintUsageByPrinterRequestBuilder} from './monthlyPrintUsageByPrinter/monthlyPrintUsageByPrinterRequestBuilder';
import {PrintUsageByUserItemRequestBuilder as if76a775215e2a329320593b524aff41cbdb4889b01026f185f1c47275f4cdde2} from './monthlyPrintUsageByUser/item/printUsageByUserItemRequestBuilder';
...
export class ReportsRequestBuilder {
     ...
     */
    public dailyPrintUsageByPrinterById(id: string) : i999f934e366eb591b3ee866ea634bcf91706140d924598be6fc20d94119758a7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["printUsageByPrinter%2Did"] = id
        return new i999f934e366eb591b3ee866ea634bcf91706140d924598be6fc20d94119758a7(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the dailyPrintUsageByUser property of the microsoft.graph.reportRoot entity.
     * @param id Unique identifier of the item
     ...
     */
    public dailyPrintUsageByUserById(id: string) : ib4d89d616f0f9478489dad3d7dc4326f7419ae7b40bc6ddf346d0c49d382b870 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["printUsageByUser%2Did"] = id
        return new ib4d89d616f0f9478489dad3d7dc4326f7419ae7b40bc6ddf346d0c49d382b870(urlTplParams, this.requestAdapter);
    };
    /**
    ...
    public get(requestConfiguration?: ReportsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ReportRoot | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ReportRoot>(requestInfo,deserializeIntoReportRoot, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     ...
     * @returns a PrintUsageByPrinterItemRequestBuilder
     */
    public monthlyPrintUsageByPrinterById(id: string) : i92d55dadeb2b9bd47045870472c2cf7fc0ff25deda0749b050d8e77bb5ec9bbe {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["printUsageByPrinter%2Did"] = id
        return new i92d55dadeb2b9bd47045870472c2cf7fc0ff25deda0749b050d8e77bb5ec9bbe(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the monthlyPrintUsageByUser property of the microsoft.graph.reportRoot entity.
     * @param id Unique identifier of the item
     * @returns a PrintUsageByUserItemRequestBuilder
     */
    public monthlyPrintUsageByUserById(id: string) : if76a775215e2a329320593b524aff41cbdb4889b01026f185f1c47275f4cdde2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["printUsageByUser%2Did"] = id
        return new if76a775215e2a329320593b524aff41cbdb4889b01026f185f1c47275f4cdde2(urlTplParams, this.requestAdapter);
    };
    /**
     * Update reports
     * @param body 
