...
import {serializeGetAttackSimulationRepeatOffendersResponse} from './serializeGetAttackSimulationRepeatOffendersResponse';
...
export class GetAttackSimulationRepeatOffendersRequestBuilder {
    ...
    public get(requestConfiguration?: GetAttackSimulationRepeatOffendersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetAttackSimulationRepeatOffendersResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetAttackSimulationRepeatOffendersResponse>(requestInfo,deserializeIntoGetAttackSimulationRepeatOffendersResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
