...
import {deserializeIntoBitlockerRecoveryKey} from '../../../../models/deserializeIntoBitlockerRecoveryKey';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeBitlockerRecoveryKey} from '../../../../models/serializeBitlockerRecoveryKey';
...
export class BitlockerRecoveryKeyItemRequestBuilder {
    ...
    public get(requestConfiguration?: BitlockerRecoveryKeyItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<BitlockerRecoveryKey | undefined> {
        ...
        return this.requestAdapter?.sendAsync<BitlockerRecoveryKey>(requestInfo,deserializeIntoBitlockerRecoveryKey, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
