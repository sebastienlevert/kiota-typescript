...
import {deserializeIntoBitlocker} from '../../models/deserializeIntoBitlocker';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeBitlocker} from '../../models/serializeBitlocker';
...
export class BitlockerRequestBuilder {
    ...
    public get(requestConfiguration?: BitlockerRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Bitlocker | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Bitlocker>(requestInfo,deserializeIntoBitlocker, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Provides operations to manage the recoveryKeys property of the microsoft.graph.bitlocker entity.
