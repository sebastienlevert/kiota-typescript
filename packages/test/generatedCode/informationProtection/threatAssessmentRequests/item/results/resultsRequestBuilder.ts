...
import {deserializeIntoThreatAssessmentResultCollectionResponse} from '../../../../models/deserializeIntoThreatAssessmentResultCollectionResponse';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeThreatAssessmentResult} from '../../../../models/serializeThreatAssessmentResult';
import {serializeThreatAssessmentResultCollectionResponse} from '../../../../models/serializeThreatAssessmentResultCollectionResponse';
...
export class ResultsRequestBuilder {
    ...
    public get(requestConfiguration?: ResultsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ThreatAssessmentResultCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ThreatAssessmentResultCollectionResponse>(requestInfo,deserializeIntoThreatAssessmentResultCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to results for informationProtection
     * @param body 
    ...
    public post(body: ThreatAssessmentResult | undefined, requestConfiguration?: ResultsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ThreatAssessmentResult | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ThreatAssessmentResult>(requestInfo,deserializeIntoThreatAssessmentResult, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
