...
import {deserializeIntoConnectedOrganizationCollectionResponse} from '../../../models/deserializeIntoConnectedOrganizationCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeConnectedOrganization} from '../../../models/serializeConnectedOrganization';
import {serializeConnectedOrganizationCollectionResponse} from '../../../models/serializeConnectedOrganizationCollectionResponse';
...
export class ConnectedOrganizationsRequestBuilder {
    ...
    public get(requestConfiguration?: ConnectedOrganizationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConnectedOrganizationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ConnectedOrganizationCollectionResponse>(requestInfo,deserializeIntoConnectedOrganizationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to connectedOrganizations for identityGovernance
     * @param body 
