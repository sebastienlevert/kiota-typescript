...
import {deserializeIntoAccessPackageAssignmentCollectionResponse} from '../../../models/deserializeIntoAccessPackageAssignmentCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeAccessPackageAssignment} from '../../../models/serializeAccessPackageAssignment';
import {serializeAccessPackageAssignmentCollectionResponse} from '../../../models/serializeAccessPackageAssignmentCollectionResponse';
...
export class AssignmentsRequestBuilder {
    ...
    public get(requestConfiguration?: AssignmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessPackageAssignmentCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AccessPackageAssignmentCollectionResponse>(requestInfo,deserializeIntoAccessPackageAssignmentCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to assignments for identityGovernance
     * @param body 
