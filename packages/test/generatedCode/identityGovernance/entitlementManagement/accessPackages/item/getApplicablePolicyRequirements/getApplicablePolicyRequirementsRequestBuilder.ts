...
import {serializeGetApplicablePolicyRequirementsResponse} from './serializeGetApplicablePolicyRequirementsResponse';
...
export class GetApplicablePolicyRequirementsRequestBuilder {
    ...
    public post(requestConfiguration?: GetApplicablePolicyRequirementsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetApplicablePolicyRequirementsResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetApplicablePolicyRequirementsResponse>(requestInfo,deserializeIntoGetApplicablePolicyRequirementsResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
