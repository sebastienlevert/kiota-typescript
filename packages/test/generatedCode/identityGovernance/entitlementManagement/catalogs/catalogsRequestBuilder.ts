...
import {deserializeIntoAccessPackageCatalogCollectionResponse} from '../../../models/deserializeIntoAccessPackageCatalogCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeAccessPackageCatalog} from '../../../models/serializeAccessPackageCatalog';
import {serializeAccessPackageCatalogCollectionResponse} from '../../../models/serializeAccessPackageCatalogCollectionResponse';
...
export class CatalogsRequestBuilder {
    ...
    public get(requestConfiguration?: CatalogsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AccessPackageCatalogCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AccessPackageCatalogCollectionResponse>(requestInfo,deserializeIntoAccessPackageCatalogCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new accessPackageCatalog object.
     * @param body 
