...
import {deserializeIntoApprovalStageCollectionResponse} from '../../../../../../../../models/deserializeIntoApprovalStageCollectionResponse';
import {ODataError} from '../../../../../../../../models/oDataErrors/oDataError';
import {serializeApprovalStage} from '../../../../../../../../models/serializeApprovalStage';
import {serializeApprovalStageCollectionResponse} from '../../../../../../../../models/serializeApprovalStageCollectionResponse';
...
export class StagesRequestBuilder {
    ...
    public get(requestConfiguration?: StagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ApprovalStageCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ApprovalStageCollectionResponse>(requestInfo,deserializeIntoApprovalStageCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to stages for identityGovernance
     * @param body 
