...
import {deserializeIntoProvisioningObjectSummaryCollectionResponse} from '../../models/deserializeIntoProvisioningObjectSummaryCollectionResponse';
...
import {serializeProvisioningObjectSummaryCollectionResponse} from '../../models/serializeProvisioningObjectSummaryCollectionResponse';
...
export class ProvisioningRequestBuilder {
    ...
    public get(requestConfiguration?: ProvisioningRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ProvisioningObjectSummaryCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ProvisioningObjectSummaryCollectionResponse>(requestInfo,deserializeIntoProvisioningObjectSummaryCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to provisioning for auditLogs
     * @param body 
    ...
    public post(body: ProvisioningObjectSummary | undefined, requestConfiguration?: ProvisioningRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ProvisioningObjectSummary | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ProvisioningObjectSummary>(requestInfo,deserializeIntoProvisioningObjectSummary, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
