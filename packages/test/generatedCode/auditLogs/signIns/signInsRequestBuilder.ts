...
import {deserializeIntoSignInCollectionResponse} from '../../models/deserializeIntoSignInCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeSignIn} from '../../models/serializeSignIn';
import {serializeSignInCollectionResponse} from '../../models/serializeSignInCollectionResponse';
...
export class SignInsRequestBuilder {
    ...
    public get(requestConfiguration?: SignInsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SignInCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SignInCollectionResponse>(requestInfo,deserializeIntoSignInCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to signIns for auditLogs
     * @param body 
