import {deserializeIntoInventoryResponse} from './deserializeIntoInventoryResponse';
...
import {serializeInventoryResponse} from './serializeInventoryResponse';
...
export class InventoryRequestBuilder {
     ...
     */
    public createGetRequestInformation(requestConfiguration?: InventoryRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
    ...
    public get(requestConfiguration?: InventoryRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<InventoryResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<InventoryResponse>(requestInfo,deserializeIntoInventoryResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
