...
export class OrderRequestBuilder {
     ...
     */
    public createPostRequestInformation(body: Order | undefined, requestConfiguration?: OrderRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeOrder);
        return requestInfo;
    };
    /**
     * Place a new order in the store
