...
import {deserializeIntoPlannerBucketCollectionResponse} from '../../models/deserializeIntoPlannerBucketCollectionResponse';
...
import {serializePlannerBucketCollectionResponse} from '../../models/serializePlannerBucketCollectionResponse';
...
export class BucketsRequestBuilder {
    ...
    public get(requestConfiguration?: BucketsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PlannerBucketCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PlannerBucketCollectionResponse>(requestInfo,deserializeIntoPlannerBucketCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new plannerBucket object.
     * @param body 
