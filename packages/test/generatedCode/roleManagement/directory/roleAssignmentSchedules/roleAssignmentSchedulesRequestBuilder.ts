...
import {deserializeIntoUnifiedRoleAssignmentScheduleCollectionResponse} from '../../../models/deserializeIntoUnifiedRoleAssignmentScheduleCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeUnifiedRoleAssignmentSchedule} from '../../../models/serializeUnifiedRoleAssignmentSchedule';
import {serializeUnifiedRoleAssignmentScheduleCollectionResponse} from '../../../models/serializeUnifiedRoleAssignmentScheduleCollectionResponse';
...
export class RoleAssignmentSchedulesRequestBuilder {
    ...
    public get(requestConfiguration?: RoleAssignmentSchedulesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleAssignmentScheduleCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleAssignmentScheduleCollectionResponse>(requestInfo,deserializeIntoUnifiedRoleAssignmentScheduleCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to roleAssignmentSchedules for roleManagement
     * @param body 
    ...
    public post(body: UnifiedRoleAssignmentSchedule | undefined, requestConfiguration?: RoleAssignmentSchedulesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleAssignmentSchedule | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleAssignmentSchedule>(requestInfo,deserializeIntoUnifiedRoleAssignmentSchedule, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
