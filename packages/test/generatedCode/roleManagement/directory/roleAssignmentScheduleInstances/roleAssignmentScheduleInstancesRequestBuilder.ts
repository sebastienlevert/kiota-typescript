...
import {deserializeIntoUnifiedRoleAssignmentScheduleInstanceCollectionResponse} from '../../../models/deserializeIntoUnifiedRoleAssignmentScheduleInstanceCollectionResponse';
...
import {serializeUnifiedRoleAssignmentScheduleInstanceCollectionResponse} from '../../../models/serializeUnifiedRoleAssignmentScheduleInstanceCollectionResponse';
...
export class RoleAssignmentScheduleInstancesRequestBuilder {
    ...
    public get(requestConfiguration?: RoleAssignmentScheduleInstancesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleAssignmentScheduleInstanceCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleAssignmentScheduleInstanceCollectionResponse>(requestInfo,deserializeIntoUnifiedRoleAssignmentScheduleInstanceCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to roleAssignmentScheduleInstances for roleManagement
     * @param body 
    ...
    public post(body: UnifiedRoleAssignmentScheduleInstance | undefined, requestConfiguration?: RoleAssignmentScheduleInstancesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleAssignmentScheduleInstance | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleAssignmentScheduleInstance>(requestInfo,deserializeIntoUnifiedRoleAssignmentScheduleInstance, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
