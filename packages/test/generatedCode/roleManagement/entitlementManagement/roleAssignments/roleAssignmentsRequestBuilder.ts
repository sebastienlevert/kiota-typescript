...
import {deserializeIntoUnifiedRoleAssignmentCollectionResponse} from '../../../models/deserializeIntoUnifiedRoleAssignmentCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeUnifiedRoleAssignment} from '../../../models/serializeUnifiedRoleAssignment';
import {serializeUnifiedRoleAssignmentCollectionResponse} from '../../../models/serializeUnifiedRoleAssignmentCollectionResponse';
...
export class RoleAssignmentsRequestBuilder {
    ...
    public get(requestConfiguration?: RoleAssignmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnifiedRoleAssignmentCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnifiedRoleAssignmentCollectionResponse>(requestInfo,deserializeIntoUnifiedRoleAssignmentCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new unifiedRoleAssignment object.
     * @param body 
