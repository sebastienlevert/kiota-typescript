...
export class ComplianceRequestBuilder {
    ...
    public get(requestConfiguration?: ComplianceRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Compliance | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Compliance>(requestInfo,deserializeIntoCompliance, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update compliance
     * @param body 
