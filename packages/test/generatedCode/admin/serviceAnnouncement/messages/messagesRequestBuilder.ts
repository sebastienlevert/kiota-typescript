...
import {deserializeIntoServiceUpdateMessageCollectionResponse} from '../../../models/deserializeIntoServiceUpdateMessageCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeServiceUpdateMessage} from '../../../models/serializeServiceUpdateMessage';
import {serializeServiceUpdateMessageCollectionResponse} from '../../../models/serializeServiceUpdateMessageCollectionResponse';
...
export class MessagesRequestBuilder {
    ...
    public get(requestConfiguration?: MessagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServiceUpdateMessageCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ServiceUpdateMessageCollectionResponse>(requestInfo,deserializeIntoServiceUpdateMessageCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to messages for admin
     * @param body 
    ...
    public post(body: ServiceUpdateMessage | undefined, requestConfiguration?: MessagesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServiceUpdateMessage | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ServiceUpdateMessage>(requestInfo,deserializeIntoServiceUpdateMessage, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
