...
import {deserializeIntoServiceAnnouncementAttachmentCollectionResponse} from '../../../../../models/deserializeIntoServiceAnnouncementAttachmentCollectionResponse';
import {ODataError} from '../../../../../models/oDataErrors/oDataError';
import {serializeServiceAnnouncementAttachment} from '../../../../../models/serializeServiceAnnouncementAttachment';
import {serializeServiceAnnouncementAttachmentCollectionResponse} from '../../../../../models/serializeServiceAnnouncementAttachmentCollectionResponse';
...
export class AttachmentsRequestBuilder {
    ...
    public get(requestConfiguration?: AttachmentsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServiceAnnouncementAttachmentCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ServiceAnnouncementAttachmentCollectionResponse>(requestInfo,deserializeIntoServiceAnnouncementAttachmentCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to attachments for admin
     * @param body 
    ...
    public post(body: ServiceAnnouncementAttachment | undefined, requestConfiguration?: AttachmentsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ServiceAnnouncementAttachment | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ServiceAnnouncementAttachment>(requestInfo,deserializeIntoServiceAnnouncementAttachment, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
