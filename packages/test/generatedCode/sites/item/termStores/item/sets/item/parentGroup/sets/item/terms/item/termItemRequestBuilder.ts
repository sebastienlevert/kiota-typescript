...
import {TermItemRequestBuilder as ic24f9c4095e2f3f59bcf14532bb112366380f867f834bef272890ee59b47b45b} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : ic24f9c4095e2f3f59bcf14532bb112366380f867f834bef272890ee59b47b45b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new ic24f9c4095e2f3f59bcf14532bb112366380f867f834bef272890ee59b47b45b(urlTplParams, this.requestAdapter);
    };
    /**
