...
import {TermItemRequestBuilder as i989d0effc80faf56200fe5e99d88acfd95f16e86074d4c965354b344b39a624e} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i989d0effc80faf56200fe5e99d88acfd95f16e86074d4c965354b344b39a624e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i989d0effc80faf56200fe5e99d88acfd95f16e86074d4c965354b344b39a624e(urlTplParams, this.requestAdapter);
    };
    /**
