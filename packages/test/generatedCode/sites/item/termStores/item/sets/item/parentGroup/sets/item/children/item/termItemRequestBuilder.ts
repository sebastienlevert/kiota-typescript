...
import {TermItemRequestBuilder as i99531e5592343ab1f62502d2a8574ae1343b8bded54ca0ac99b67ba290f7a5f2} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i99531e5592343ab1f62502d2a8574ae1343b8bded54ca0ac99b67ba290f7a5f2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i99531e5592343ab1f62502d2a8574ae1343b8bded54ca0ac99b67ba290f7a5f2(urlTplParams, this.requestAdapter);
    };
    /**
