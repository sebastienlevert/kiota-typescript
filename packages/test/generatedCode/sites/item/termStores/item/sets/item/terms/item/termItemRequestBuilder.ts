...
import {TermItemRequestBuilder as i6adb3d3c20417679a11267fc6f7e71ee3fd0edc147551038d6f93f47939f11c6} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i6adb3d3c20417679a11267fc6f7e71ee3fd0edc147551038d6f93f47939f11c6 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i6adb3d3c20417679a11267fc6f7e71ee3fd0edc147551038d6f93f47939f11c6(urlTplParams, this.requestAdapter);
    };
    /**
