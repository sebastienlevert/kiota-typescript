...
import {TermItemRequestBuilder as i5f9b7db3e75c2069a012fee438781e422eb4231e4b1be2685ecb4102b5d57ef7} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as ia2c67468f0348366f7fbb348de84a188e64de781d74a09eb679754916f86d495} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i5f9b7db3e75c2069a012fee438781e422eb4231e4b1be2685ecb4102b5d57ef7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i5f9b7db3e75c2069a012fee438781e422eb4231e4b1be2685ecb4102b5d57ef7(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : ia2c67468f0348366f7fbb348de84a188e64de781d74a09eb679754916f86d495 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new ia2c67468f0348366f7fbb348de84a188e64de781d74a09eb679754916f86d495(urlTplParams, this.requestAdapter);
    };
}
