...
import {TermItemRequestBuilder as i466dc2d483f0c11fb82de5e4e8eebcbe8808dadd3aced3cd3078385ae5a0dfac} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as i8ec55d286ed74af60a07acd200a13352ac7fa19a650565c3996e888b7e762162} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i466dc2d483f0c11fb82de5e4e8eebcbe8808dadd3aced3cd3078385ae5a0dfac {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i466dc2d483f0c11fb82de5e4e8eebcbe8808dadd3aced3cd3078385ae5a0dfac(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : i8ec55d286ed74af60a07acd200a13352ac7fa19a650565c3996e888b7e762162 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i8ec55d286ed74af60a07acd200a13352ac7fa19a650565c3996e888b7e762162(urlTplParams, this.requestAdapter);
    };
}
