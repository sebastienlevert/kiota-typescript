...
import {TermItemRequestBuilder as ic9f63822a28e3f369b78f56cd620228842f65db1a27bac07124d44f461054470} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : ic9f63822a28e3f369b78f56cd620228842f65db1a27bac07124d44f461054470 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new ic9f63822a28e3f369b78f56cd620228842f65db1a27bac07124d44f461054470(urlTplParams, this.requestAdapter);
    };
    /**
