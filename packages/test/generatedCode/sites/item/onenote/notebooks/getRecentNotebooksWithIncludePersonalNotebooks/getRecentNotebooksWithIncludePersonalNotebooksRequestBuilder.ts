...
import {serializeGetRecentNotebooksWithIncludePersonalNotebooksResponse} from './serializeGetRecentNotebooksWithIncludePersonalNotebooksResponse';
...
export class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder {
    ...
    public get(requestConfiguration?: GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetRecentNotebooksWithIncludePersonalNotebooksResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetRecentNotebooksWithIncludePersonalNotebooksResponse>(requestInfo,deserializeIntoGetRecentNotebooksWithIncludePersonalNotebooksResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
