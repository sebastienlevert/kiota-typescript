...
import {SectionGroupItemRequestBuilder as i2652c690fabe33cf2d19944dd78a76b142028726d7cc1a6471cae484f235e5c6} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i2652c690fabe33cf2d19944dd78a76b142028726d7cc1a6471cae484f235e5c6 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new i2652c690fabe33cf2d19944dd78a76b142028726d7cc1a6471cae484f235e5c6(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
