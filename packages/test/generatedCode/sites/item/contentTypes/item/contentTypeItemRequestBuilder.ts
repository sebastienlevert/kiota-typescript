...
import {ContentTypeItemRequestBuilder as i9c9aa883815ad5c32aa1a9f56c8d552a6d9daa33aa7bc5ba198a1a32a6b6d883} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as icbd91dc1efb5c3060fa6fd762d0b7eea2c79e460b480ab4843a0d5fb5bfdc5d0} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i38ccc3cee28c407c656a14013a7403e32a57c1713df15b8e34b87f78ad0eb646} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : i9c9aa883815ad5c32aa1a9f56c8d552a6d9daa33aa7bc5ba198a1a32a6b6d883 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new i9c9aa883815ad5c32aa1a9f56c8d552a6d9daa33aa7bc5ba198a1a32a6b6d883(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : icbd91dc1efb5c3060fa6fd762d0b7eea2c79e460b480ab4843a0d5fb5bfdc5d0 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new icbd91dc1efb5c3060fa6fd762d0b7eea2c79e460b480ab4843a0d5fb5bfdc5d0(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i38ccc3cee28c407c656a14013a7403e32a57c1713df15b8e34b87f78ad0eb646 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i38ccc3cee28c407c656a14013a7403e32a57c1713df15b8e34b87f78ad0eb646(urlTplParams, this.requestAdapter);
    };
    /**
