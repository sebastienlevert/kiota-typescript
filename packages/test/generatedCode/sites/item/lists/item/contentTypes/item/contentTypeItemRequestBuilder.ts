...
import {ContentTypeItemRequestBuilder as i4b02684ad787ec3e41f75b18ba57c20c0f88b0612774cae9641bd41b535bf09a} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as i6974f323aa722e88b8fdee524c0cfcc3575e61d1ede37b9b8d821f0161c781d1} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i5f05c50f616f809e5f4084f47a74caa38b3003bda54730baa1e95a5da653d779} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : i4b02684ad787ec3e41f75b18ba57c20c0f88b0612774cae9641bd41b535bf09a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new i4b02684ad787ec3e41f75b18ba57c20c0f88b0612774cae9641bd41b535bf09a(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : i6974f323aa722e88b8fdee524c0cfcc3575e61d1ede37b9b8d821f0161c781d1 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i6974f323aa722e88b8fdee524c0cfcc3575e61d1ede37b9b8d821f0161c781d1(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i5f05c50f616f809e5f4084f47a74caa38b3003bda54730baa1e95a5da653d779 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i5f05c50f616f809e5f4084f47a74caa38b3003bda54730baa1e95a5da653d779(urlTplParams, this.requestAdapter);
    };
    /**
