...
import {ColumnDefinitionItemRequestBuilder as if226816fdaead93490284cbee5a9ac1fcfb19b7950d7c594be200464a075b539} from './columns/item/columnDefinitionItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as i94e038230a015670184930c344eca81fde670fa949c359879462a63dde506102} from './externalColumns/item/columnDefinitionItemRequestBuilder';
...
import {SiteItemRequestBuilder as i698b14f05d8b9641b8908a3701e7d9825901a611bfce72afab5eb517c4b97912} from './sites/item/siteItemRequestBuilder';
...
export class SiteItemRequestBuilder {
     ...
     */
    public columnsById(id: string) : if226816fdaead93490284cbee5a9ac1fcfb19b7950d7c594be200464a075b539 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new if226816fdaead93490284cbee5a9ac1fcfb19b7950d7c594be200464a075b539(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public externalColumnsById(id: string) : i94e038230a015670184930c344eca81fde670fa949c359879462a63dde506102 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i94e038230a015670184930c344eca81fde670fa949c359879462a63dde506102(urlTplParams, this.requestAdapter);
    };
    /**
     * Retrieve properties and relationships for a [site][] resource.A **site** resource represents a team site in SharePoint.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
    public sitesById(id: string) : i698b14f05d8b9641b8908a3701e7d9825901a611bfce72afab5eb517c4b97912 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["site%2Did1"] = id
        return new i698b14f05d8b9641b8908a3701e7d9825901a611bfce72afab5eb517c4b97912(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the termStores property of the microsoft.graph.site entity.
     * @param id Unique identifier of the item
