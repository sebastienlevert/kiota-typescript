...
import {TermItemRequestBuilder as i860b644edb6a473f81c5a3018b61021fab65334658240977ce8d10949511b8c7} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i860b644edb6a473f81c5a3018b61021fab65334658240977ce8d10949511b8c7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i860b644edb6a473f81c5a3018b61021fab65334658240977ce8d10949511b8c7(urlTplParams, this.requestAdapter);
    };
    /**
