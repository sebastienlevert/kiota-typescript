...
import {TermItemRequestBuilder as i63e95066be7520246189caec8e745388be5de21aac64c5ea602bba02d41c62b4} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i63e95066be7520246189caec8e745388be5de21aac64c5ea602bba02d41c62b4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i63e95066be7520246189caec8e745388be5de21aac64c5ea602bba02d41c62b4(urlTplParams, this.requestAdapter);
    };
    /**
