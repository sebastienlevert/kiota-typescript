...
import {TermItemRequestBuilder as i15ab0b5fc9080eb738192a0c8635bc7b34935efc5854b9b6bed2e350627da3ae} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as i131a8e79c1117cc8fa08f9469497427521488a356f93954f727c8a0ed5cd3086} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i15ab0b5fc9080eb738192a0c8635bc7b34935efc5854b9b6bed2e350627da3ae {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i15ab0b5fc9080eb738192a0c8635bc7b34935efc5854b9b6bed2e350627da3ae(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : i131a8e79c1117cc8fa08f9469497427521488a356f93954f727c8a0ed5cd3086 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i131a8e79c1117cc8fa08f9469497427521488a356f93954f727c8a0ed5cd3086(urlTplParams, this.requestAdapter);
    };
}
