...
import {TermItemRequestBuilder as i655666aab952b226c9bd38359b06ae8985ee7d7d5bf617513597438f50a9c2f7} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i655666aab952b226c9bd38359b06ae8985ee7d7d5bf617513597438f50a9c2f7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i655666aab952b226c9bd38359b06ae8985ee7d7d5bf617513597438f50a9c2f7(urlTplParams, this.requestAdapter);
    };
    /**
