...
import {TermItemRequestBuilder as icfe74ea991ace4357d03105a4dbc55f03f5c98f12308cda010ac75e65f5ffcb4} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as icc8cdb7779537de12136d42d5d817fc191e75f94adc97efa962079a9e0bea768} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : icfe74ea991ace4357d03105a4dbc55f03f5c98f12308cda010ac75e65f5ffcb4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new icfe74ea991ace4357d03105a4dbc55f03f5c98f12308cda010ac75e65f5ffcb4(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : icc8cdb7779537de12136d42d5d817fc191e75f94adc97efa962079a9e0bea768 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new icc8cdb7779537de12136d42d5d817fc191e75f94adc97efa962079a9e0bea768(urlTplParams, this.requestAdapter);
    };
}
