...
import {TermItemRequestBuilder as i17557e0487d1a7a8fa4cd787bf6cfbf760cff96c3a3bf03e1ef61d722e0688a1} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as i3a768c324d3bd4d2673bd16debd8da11d67910604a78005670d15201b313a132} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i17557e0487d1a7a8fa4cd787bf6cfbf760cff96c3a3bf03e1ef61d722e0688a1 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i17557e0487d1a7a8fa4cd787bf6cfbf760cff96c3a3bf03e1ef61d722e0688a1(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : i3a768c324d3bd4d2673bd16debd8da11d67910604a78005670d15201b313a132 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i3a768c324d3bd4d2673bd16debd8da11d67910604a78005670d15201b313a132(urlTplParams, this.requestAdapter);
    };
}
