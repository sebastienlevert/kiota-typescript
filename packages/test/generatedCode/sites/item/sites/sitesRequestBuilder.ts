import {deserializeIntoSiteCollectionResponse} from '../../../models/deserializeIntoSiteCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeSiteCollectionResponse} from '../../../models/serializeSiteCollectionResponse';
...
export class SitesRequestBuilder {
    ...
    public get(requestConfiguration?: SitesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SiteCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SiteCollectionResponse>(requestInfo,deserializeIntoSiteCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
