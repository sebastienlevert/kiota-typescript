...
import {deserializeIntoSharedDriveItemCollectionResponse} from '../models/deserializeIntoSharedDriveItemCollectionResponse';
import {ODataError} from '../models/oDataErrors/oDataError';
import {serializeSharedDriveItem} from '../models/serializeSharedDriveItem';
import {serializeSharedDriveItemCollectionResponse} from '../models/serializeSharedDriveItemCollectionResponse';
...
export class SharesRequestBuilder {
    ...
    public get(requestConfiguration?: SharesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedDriveItemCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SharedDriveItemCollectionResponse>(requestInfo,deserializeIntoSharedDriveItemCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Add new entity to shares
     * @param body 
    ...
    public post(body: SharedDriveItem | undefined, requestConfiguration?: SharesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedDriveItem | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SharedDriveItem>(requestInfo,deserializeIntoSharedDriveItem, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
