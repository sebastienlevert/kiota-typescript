...
import {ContentTypeItemRequestBuilder as ic6052d3d1c8e2411747d757e84da0e6e18aaea6762eb74389fe8342867f6b116} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as i9069981810088948ab519a4591b60e92c7451ba6e6a9150aa97a2ef1ea9af1e0} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i0ce592246c175737d680385786179f178a59878d44a7e8b02cceea0299801392} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : ic6052d3d1c8e2411747d757e84da0e6e18aaea6762eb74389fe8342867f6b116 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new ic6052d3d1c8e2411747d757e84da0e6e18aaea6762eb74389fe8342867f6b116(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : i9069981810088948ab519a4591b60e92c7451ba6e6a9150aa97a2ef1ea9af1e0 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i9069981810088948ab519a4591b60e92c7451ba6e6a9150aa97a2ef1ea9af1e0(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i0ce592246c175737d680385786179f178a59878d44a7e8b02cceea0299801392 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i0ce592246c175737d680385786179f178a59878d44a7e8b02cceea0299801392(urlTplParams, this.requestAdapter);
    };
    /**
