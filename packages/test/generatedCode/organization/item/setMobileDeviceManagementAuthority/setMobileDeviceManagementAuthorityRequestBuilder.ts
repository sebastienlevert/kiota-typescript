...
import {serializeSetMobileDeviceManagementAuthorityResponse} from './serializeSetMobileDeviceManagementAuthorityResponse';
...
export class SetMobileDeviceManagementAuthorityRequestBuilder {
    ...
    public post(requestConfiguration?: SetMobileDeviceManagementAuthorityRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SetMobileDeviceManagementAuthorityResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SetMobileDeviceManagementAuthorityResponse>(requestInfo,deserializeIntoSetMobileDeviceManagementAuthorityResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
