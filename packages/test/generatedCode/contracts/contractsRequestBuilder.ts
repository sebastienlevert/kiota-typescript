...
import {deserializeIntoContractCollectionResponse} from '../models/deserializeIntoContractCollectionResponse';
import {ODataError} from '../models/oDataErrors/oDataError';
import {serializeContract} from '../models/serializeContract';
import {serializeContractCollectionResponse} from '../models/serializeContractCollectionResponse';
...
export class ContractsRequestBuilder {
    ...
    public get(requestConfiguration?: ContractsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ContractCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ContractCollectionResponse>(requestInfo,deserializeIntoContractCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Add new entity to contracts
     * @param body 
    ...
    public post(body: Contract | undefined, requestConfiguration?: ContractsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Contract | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Contract>(requestInfo,deserializeIntoContract, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
