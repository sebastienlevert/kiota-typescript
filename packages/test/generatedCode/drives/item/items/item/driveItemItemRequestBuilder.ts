...
import {DriveItemItemRequestBuilder as if9ca235c5d4943a92c253bd31f1805dc9ee598f6e67fefad37d9858ad2311325} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : if9ca235c5d4943a92c253bd31f1805dc9ee598f6e67fefad37d9858ad2311325 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did1"] = id
        return new if9ca235c5d4943a92c253bd31f1805dc9ee598f6e67fefad37d9858ad2311325(urlTplParams, this.requestAdapter);
    };
    /**
