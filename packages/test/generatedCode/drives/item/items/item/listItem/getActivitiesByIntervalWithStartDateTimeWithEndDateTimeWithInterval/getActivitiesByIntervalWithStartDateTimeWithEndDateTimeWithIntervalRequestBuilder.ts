...
import {serializeGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse} from './serializeGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse';
...
export class GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder {
    ...
    public get(requestConfiguration?: GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse>(requestInfo,deserializeIntoGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
