...
import {deserializeIntoListItemVersionCollectionResponse} from '../../../../../../models/deserializeIntoListItemVersionCollectionResponse';
...
import {serializeListItemVersionCollectionResponse} from '../../../../../../models/serializeListItemVersionCollectionResponse';
...
export class VersionsRequestBuilder {
    ...
    public get(requestConfiguration?: VersionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ListItemVersionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ListItemVersionCollectionResponse>(requestInfo,deserializeIntoListItemVersionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to versions for drives
     * @param body 
