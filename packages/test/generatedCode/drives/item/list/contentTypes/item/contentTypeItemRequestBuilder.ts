...
import {ContentTypeItemRequestBuilder as ief4e22693c962b9d81f3a661c4fddf6e6f34af455a3b2f6d2b16c4de6035de91} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as i920592c91f6d9648f009c7a3084cded868caa20181bce2bbb05f700fec8c5443} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i902215bc575b0c88779bd1361a58c18f64dd5bf7e8f3e63a9751875e5533e30a} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : ief4e22693c962b9d81f3a661c4fddf6e6f34af455a3b2f6d2b16c4de6035de91 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new ief4e22693c962b9d81f3a661c4fddf6e6f34af455a3b2f6d2b16c4de6035de91(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : i920592c91f6d9648f009c7a3084cded868caa20181bce2bbb05f700fec8c5443 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i920592c91f6d9648f009c7a3084cded868caa20181bce2bbb05f700fec8c5443(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i902215bc575b0c88779bd1361a58c18f64dd5bf7e8f3e63a9751875e5533e30a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i902215bc575b0c88779bd1361a58c18f64dd5bf7e8f3e63a9751875e5533e30a(urlTplParams, this.requestAdapter);
    };
    /**
