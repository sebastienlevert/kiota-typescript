...
import {deserializeIntoUserFlowLanguageConfigurationCollectionResponse} from '../../../../models/deserializeIntoUserFlowLanguageConfigurationCollectionResponse';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeUserFlowLanguageConfiguration} from '../../../../models/serializeUserFlowLanguageConfiguration';
import {serializeUserFlowLanguageConfigurationCollectionResponse} from '../../../../models/serializeUserFlowLanguageConfigurationCollectionResponse';
...
export class LanguagesRequestBuilder {
    ...
    public get(requestConfiguration?: LanguagesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserFlowLanguageConfigurationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UserFlowLanguageConfigurationCollectionResponse>(requestInfo,deserializeIntoUserFlowLanguageConfigurationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to languages for identity
     * @param body 
