...
export class GetOrderRequestBuilder {
    ...
    public get(requestConfiguration?: GetOrderRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AssignmentOrder | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AssignmentOrder>(requestInfo,deserializeIntoAssignmentOrder, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
