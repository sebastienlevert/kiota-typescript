...
import {ContactFolderItemRequestBuilder as if1489e36ee0eec3829def038e7fd4ecd14857ff6f9e3134443b9192825cae532} from './childFolders/item/contactFolderItemRequestBuilder';
...
export class ContactFolderItemRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : if1489e36ee0eec3829def038e7fd4ecd14857ff6f9e3134443b9192825cae532 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contactFolder%2Did1"] = id
        return new if1489e36ee0eec3829def038e7fd4ecd14857ff6f9e3134443b9192825cae532(urlTplParams, this.requestAdapter);
    };
    /**
