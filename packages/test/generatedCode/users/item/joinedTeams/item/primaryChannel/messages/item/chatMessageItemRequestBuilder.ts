...
import {ChatMessageItemRequestBuilder as i38f274582c69d2da8634fd9c9988df4e41e0b7c999209c91044feff92554e53f} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i38f274582c69d2da8634fd9c9988df4e41e0b7c999209c91044feff92554e53f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i38f274582c69d2da8634fd9c9988df4e41e0b7c999209c91044feff92554e53f(urlTplParams, this.requestAdapter);
    };
}
