...
import {deserializeIntoTimeOffReasonCollectionResponse} from '../../../../../../models/deserializeIntoTimeOffReasonCollectionResponse';
import {ODataError} from '../../../../../../models/oDataErrors/oDataError';
import {serializeTimeOffReason} from '../../../../../../models/serializeTimeOffReason';
import {serializeTimeOffReasonCollectionResponse} from '../../../../../../models/serializeTimeOffReasonCollectionResponse';
...
export class TimeOffReasonsRequestBuilder {
    ...
    public get(requestConfiguration?: TimeOffReasonsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TimeOffReasonCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TimeOffReasonCollectionResponse>(requestInfo,deserializeIntoTimeOffReasonCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new timeOffReason.
     * @param body 
    ...
    public post(body: TimeOffReason | undefined, requestConfiguration?: TimeOffReasonsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TimeOffReason | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TimeOffReason>(requestInfo,deserializeIntoTimeOffReason, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
