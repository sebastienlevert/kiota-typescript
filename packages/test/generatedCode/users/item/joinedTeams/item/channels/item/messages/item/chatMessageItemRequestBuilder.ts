...
import {ChatMessageItemRequestBuilder as i68abf18e9b278bb21c2c6c2ca567cbac67259d78b9ff3677f650a3fc2fa30693} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i68abf18e9b278bb21c2c6c2ca567cbac67259d78b9ff3677f650a3fc2fa30693 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i68abf18e9b278bb21c2c6c2ca567cbac67259d78b9ff3677f650a3fc2fa30693(urlTplParams, this.requestAdapter);
    };
}
