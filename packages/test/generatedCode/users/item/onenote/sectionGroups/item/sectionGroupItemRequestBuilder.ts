...
import {SectionGroupItemRequestBuilder as ib7c1a890c8e1bb7c32d0953817133fbcb281d5ccba74e4f246ee58fad8f041dc} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : ib7c1a890c8e1bb7c32d0953817133fbcb281d5ccba74e4f246ee58fad8f041dc {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new ib7c1a890c8e1bb7c32d0953817133fbcb281d5ccba74e4f246ee58fad8f041dc(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
