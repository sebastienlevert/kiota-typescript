import {deserializeIntoOnenotePagePreview} from '../../../../../../../../../../models/deserializeIntoOnenotePagePreview';
import {ODataError} from '../../../../../../../../../../models/oDataErrors/oDataError';
import {OnenotePagePreview} from '../../../../../../../../../../models/onenotePagePreview';
import {serializeOnenotePagePreview} from '../../../../../../../../../../models/serializeOnenotePagePreview';
...
export class PreviewRequestBuilder {
    ...
    public get(requestConfiguration?: PreviewRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OnenotePagePreview | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OnenotePagePreview>(requestInfo,deserializeIntoOnenotePagePreview, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
