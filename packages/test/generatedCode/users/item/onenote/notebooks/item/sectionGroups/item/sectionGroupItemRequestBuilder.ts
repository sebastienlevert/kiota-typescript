...
import {SectionGroupItemRequestBuilder as i43f441fb8e2c684b626ff154677d5cf8b8c5f464d35e0ea4e2821b0e3c62629a} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i43f441fb8e2c684b626ff154677d5cf8b8c5f464d35e0ea4e2821b0e3c62629a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new i43f441fb8e2c684b626ff154677d5cf8b8c5f464d35e0ea4e2821b0e3c62629a(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
