...
export class TodoTaskItemRequestBuilder {
    ...
    /**
     * Gets an item from the ApiSdk.users.item.todo.lists.item.tasks.item.attachments.item collection
    ...
    /**
     * Gets an item from the ApiSdk.users.item.todo.lists.item.tasks.item.attachmentSessions.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the ApiSdk.users.item.todo.lists.item.tasks.item.checklistItems.item collection
     * @param id Unique identifier of the item
    ...
    /**
     * Gets an item from the ApiSdk.users.item.todo.lists.item.tasks.item.extensions.item collection
     * @param id Unique identifier of the item
    ...
    public get(requestConfiguration?: TodoTaskItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TodoTask | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TodoTask>(requestInfo,deserializeIntoTodoTask, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Gets an item from the ApiSdk.users.item.todo.lists.item.tasks.item.linkedResources.item collection
     * @param id Unique identifier of the item
