...
import {deserializeIntoTodoTaskCollectionResponse} from '../../../../../../models/deserializeIntoTodoTaskCollectionResponse';
import {serializeTodoTask} from '../../../../../../models/serializeTodoTask';
import {serializeTodoTaskCollectionResponse} from '../../../../../../models/serializeTodoTaskCollectionResponse';
...
export class TasksRequestBuilder {
    ...
    public get(requestConfiguration?: TasksRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TodoTaskCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TodoTaskCollectionResponse>(requestInfo,deserializeIntoTodoTaskCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new task object in a specified todoTaskList.
     * @param body 
