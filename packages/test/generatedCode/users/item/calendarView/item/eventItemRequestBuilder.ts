...
import {EventItemRequestBuilder as i8c51c99bad321b2d0eeeeca6363903e407acf91b2a84e9d10301d76dc1f31e24} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i8c51c99bad321b2d0eeeeca6363903e407acf91b2a84e9d10301d76dc1f31e24 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i8c51c99bad321b2d0eeeeca6363903e407acf91b2a84e9d10301d76dc1f31e24(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
