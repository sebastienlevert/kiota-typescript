...
import {EventItemRequestBuilder as i29232610244f13f0e31da40c49bfff303d26c873121122a4c27b1ae25ce3535e} from './calendarView/item/eventItemRequestBuilder';
import {EventsRequestBuilder} from './events/eventsRequestBuilder';
import {EventItemRequestBuilder as i9f6a8dfa23682834069738a1f21a6c1bdebaf99657720c4671c466df8dd39445} from './events/item/eventItemRequestBuilder';
...
export class CalendarItemRequestBuilder {
     ...
     */
    public calendarViewById(id: string) : i29232610244f13f0e31da40c49bfff303d26c873121122a4c27b1ae25ce3535e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i29232610244f13f0e31da40c49bfff303d26c873121122a4c27b1ae25ce3535e(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a EventItemRequestBuilder
     */
    public eventsById(id: string) : i9f6a8dfa23682834069738a1f21a6c1bdebaf99657720c4671c466df8dd39445 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i9f6a8dfa23682834069738a1f21a6c1bdebaf99657720c4671c466df8dd39445(urlTplParams, this.requestAdapter);
    };
    /**
     * The user's calendars. Read-only. Nullable.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
