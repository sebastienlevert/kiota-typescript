...
import {EventItemRequestBuilder as i807895e282ce36cba7fabe50a48d38fd14f7f3e694038aff0b7fc15beb2a979e} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i807895e282ce36cba7fabe50a48d38fd14f7f3e694038aff0b7fc15beb2a979e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i807895e282ce36cba7fabe50a48d38fd14f7f3e694038aff0b7fc15beb2a979e(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
