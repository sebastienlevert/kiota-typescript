...
import {EventItemRequestBuilder as i544c26d463c53ad7d68e411bfe8c3e35dfd75185f87c4c147172d0638aecb651} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i544c26d463c53ad7d68e411bfe8c3e35dfd75185f87c4c147172d0638aecb651 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i544c26d463c53ad7d68e411bfe8c3e35dfd75185f87c4c147172d0638aecb651(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
