import {UserInsightsSettings} from '../../../../models/';
import {createUserInsightsSettingsFromDiscriminatorValue} from '../../../../models/createUserInsightsSettingsFromDiscriminatorValue';
...
export class ItemInsightsRequestBuilder {
    ...
    public get(requestConfiguration?: ItemInsightsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserInsightsSettings | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UserInsightsSettings>(requestInfo, createUserInsightsSettingsFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the privacy settings for itemInsights and meeting hours insights of a user.
     * @param body 
