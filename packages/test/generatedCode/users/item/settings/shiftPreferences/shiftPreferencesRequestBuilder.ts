...
export class ShiftPreferencesRequestBuilder {
    ...
    public get(requestConfiguration?: ShiftPreferencesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ShiftPreferences | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ShiftPreferences>(requestInfo,deserializeIntoShiftPreferences, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the properties and relationships of a shiftPreferences object.
     * @param body 
