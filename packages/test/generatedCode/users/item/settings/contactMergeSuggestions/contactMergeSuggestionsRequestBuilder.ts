import {ContactMergeSuggestions} from '../../../../models/contactMergeSuggestions';
import {deserializeIntoContactMergeSuggestions} from '../../../../models/deserializeIntoContactMergeSuggestions';
import {serializeContactMergeSuggestions} from '../../../../models/serializeContactMergeSuggestions';
...
export class ContactMergeSuggestionsRequestBuilder {
    ...
    public createPatchRequestInformation(body: ContactMergeSuggestions | undefined, requestConfiguration?: ContactMergeSuggestionsRequestBuilderPatchRequestConfiguration | undefined) : RequestInformation {
        ...
        requestInfo.setContentFromParsable(this.requestAdapter, "application/json", body as any, serializeContactMergeSuggestions);
        return requestInfo;
    };
    /**
     * Delete navigation property contactMergeSuggestions for users
    ...
    public get(requestConfiguration?: ContactMergeSuggestionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ContactMergeSuggestions | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ContactMergeSuggestions>(requestInfo,deserializeIntoContactMergeSuggestions, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the properties of a contactMergeSuggestions object.
     * @param body 
