...
import {deserializeIntoSharedInsightCollectionResponse} from '../../../../models/deserializeIntoSharedInsightCollectionResponse';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeSharedInsight} from '../../../../models/serializeSharedInsight';
import {serializeSharedInsightCollectionResponse} from '../../../../models/serializeSharedInsightCollectionResponse';
...
export class SharedRequestBuilder {
    ...
    public get(requestConfiguration?: SharedRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SharedInsightCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SharedInsightCollectionResponse>(requestInfo,deserializeIntoSharedInsightCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to shared for users
     * @param body 
