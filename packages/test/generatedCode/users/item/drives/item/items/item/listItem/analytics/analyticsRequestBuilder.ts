...
export class AnalyticsRequestBuilder {
    ...
    public get(requestConfiguration?: AnalyticsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ItemAnalytics | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ItemAnalytics>(requestInfo,deserializeIntoItemAnalytics, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
