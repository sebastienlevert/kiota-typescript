...
import {ChatMessageItemRequestBuilder as i9723302b9076219d75023b90368fcdd7a445c07c1238adad9fa755965dd24c39} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i9723302b9076219d75023b90368fcdd7a445c07c1238adad9fa755965dd24c39 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i9723302b9076219d75023b90368fcdd7a445c07c1238adad9fa755965dd24c39(urlTplParams, this.requestAdapter);
    };
}
