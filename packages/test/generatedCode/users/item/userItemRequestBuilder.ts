...
import {EventItemRequestBuilder as i87179b946a2c0a3c8e7215fbd84ebffcb121c2c75f7d287976d42a1d63733686} from './calendarView/item/eventItemRequestBuilder';
...
import {EventItemRequestBuilder as i2a0b6e041bda088207a106ff1a7d786ec3f90255f64d1892519711890812d628} from './events/item/eventItemRequestBuilder';
...
export class UserItemRequestBuilder {
     ...
     */
    public calendarViewById(id: string) : i87179b946a2c0a3c8e7215fbd84ebffcb121c2c75f7d287976d42a1d63733686 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i87179b946a2c0a3c8e7215fbd84ebffcb121c2c75f7d287976d42a1d63733686(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the chats property of the microsoft.graph.user entity.
     * @param id Unique identifier of the item
     ...
     * @returns a EventItemRequestBuilder
     */
    public eventsById(id: string) : i2a0b6e041bda088207a106ff1a7d786ec3f90255f64d1892519711890812d628 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i2a0b6e041bda088207a106ff1a7d786ec3f90255f64d1892519711890812d628(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the extensions property of the microsoft.graph.user entity.
     * @param id Unique identifier of the item
