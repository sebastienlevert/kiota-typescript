import {deserializeIntoManagedAppRegistrationCollectionResponse} from '../../../models/deserializeIntoManagedAppRegistrationCollectionResponse';
import {ManagedAppRegistrationCollectionResponse} from '../../../models/managedAppRegistrationCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeManagedAppRegistrationCollectionResponse} from '../../../models/serializeManagedAppRegistrationCollectionResponse';
...
export class ManagedAppRegistrationsRequestBuilder {
    ...
    public get(requestConfiguration?: ManagedAppRegistrationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedAppRegistrationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ManagedAppRegistrationCollectionResponse>(requestInfo,deserializeIntoManagedAppRegistrationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
