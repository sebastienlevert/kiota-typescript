...
import {EventItemRequestBuilder as i6f3238e0f3e1a513a9b634f548a4777919f424cec51cdd72c81730a96279dc08} from './calendarView/item/eventItemRequestBuilder';
import {EventsRequestBuilder} from './events/eventsRequestBuilder';
import {EventItemRequestBuilder as i0c6f248485935270b777a9846f664eccbd169c3c0ba61de449a1995735cb1275} from './events/item/eventItemRequestBuilder';
...
export class CalendarItemRequestBuilder {
     ...
     */
    public calendarViewById(id: string) : i6f3238e0f3e1a513a9b634f548a4777919f424cec51cdd72c81730a96279dc08 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i6f3238e0f3e1a513a9b634f548a4777919f424cec51cdd72c81730a96279dc08(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a EventItemRequestBuilder
     */
    public eventsById(id: string) : i0c6f248485935270b777a9846f664eccbd169c3c0ba61de449a1995735cb1275 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i0c6f248485935270b777a9846f664eccbd169c3c0ba61de449a1995735cb1275(urlTplParams, this.requestAdapter);
    };
    /**
     * The calendars in the calendar group. Navigation property. Read-only. Nullable.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
