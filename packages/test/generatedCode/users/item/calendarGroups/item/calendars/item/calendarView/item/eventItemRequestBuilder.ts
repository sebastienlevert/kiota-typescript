...
import {EventItemRequestBuilder as i5e56657c11bcc917509fae1cb0401d1c100f1704dcd68546b421433baddb338d} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i5e56657c11bcc917509fae1cb0401d1c100f1704dcd68546b421433baddb338d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i5e56657c11bcc917509fae1cb0401d1c100f1704dcd68546b421433baddb338d(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
