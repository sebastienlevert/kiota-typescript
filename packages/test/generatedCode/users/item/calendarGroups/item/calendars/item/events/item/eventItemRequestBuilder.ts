...
import {EventItemRequestBuilder as ia26582e054dfd29b9d1a2ac97843a3ea01b4ddb26a8b0d9c54bac1ad0bcbff2d} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ia26582e054dfd29b9d1a2ac97843a3ea01b4ddb26a8b0d9c54bac1ad0bcbff2d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new ia26582e054dfd29b9d1a2ac97843a3ea01b4ddb26a8b0d9c54bac1ad0bcbff2d(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
