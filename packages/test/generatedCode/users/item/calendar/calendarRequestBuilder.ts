...
import {EventItemRequestBuilder as i79a4f2471eaab3d224aa76251d6045c8206b0dc1a3c10a7f31682ce310952f97} from './calendarView/item/eventItemRequestBuilder';
import {EventsRequestBuilder} from './events/eventsRequestBuilder';
import {EventItemRequestBuilder as i5f4637cb96ee2d04302180a4b67f80c60134efb5c0be5ca5046e9583230d12dd} from './events/item/eventItemRequestBuilder';
...
export class CalendarRequestBuilder {
     ...
     */
    public calendarViewById(id: string) : i79a4f2471eaab3d224aa76251d6045c8206b0dc1a3c10a7f31682ce310952f97 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i79a4f2471eaab3d224aa76251d6045c8206b0dc1a3c10a7f31682ce310952f97(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a EventItemRequestBuilder
     */
    public eventsById(id: string) : i5f4637cb96ee2d04302180a4b67f80c60134efb5c0be5ca5046e9583230d12dd {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i5f4637cb96ee2d04302180a4b67f80c60134efb5c0be5ca5046e9583230d12dd(urlTplParams, this.requestAdapter);
    };
    /**
     * Get the properties and relationships of a calendar object. The calendar can be one for a user, or the default calendar of a Microsoft 365 group. There are two scenarios where an app can get another user's calendar:
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
