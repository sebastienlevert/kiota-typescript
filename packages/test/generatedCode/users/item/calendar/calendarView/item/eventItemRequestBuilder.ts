...
import {EventItemRequestBuilder as i339d85097c370527831c48af13c46f0db03be14d8910aa65b9d6985920cdb5f7} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i339d85097c370527831c48af13c46f0db03be14d8910aa65b9d6985920cdb5f7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i339d85097c370527831c48af13c46f0db03be14d8910aa65b9d6985920cdb5f7(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
