...
import {EventItemRequestBuilder as i474e1137c3f4636e074882156270ae90e288107b47e1aee0ab71ef25f782b4d1} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i474e1137c3f4636e074882156270ae90e288107b47e1aee0ab71ef25f782b4d1 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i474e1137c3f4636e074882156270ae90e288107b47e1aee0ab71ef25f782b4d1(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
