...
import {DirectoryObjectItemRequestBuilder as iad13a205c6b54646aac3aaf517cb4e2badd50fbbe56a0e14b8b331388759bbf4} from './memberOf/item/directoryObjectItemRequestBuilder';
import {MemberOfRequestBuilder} from './memberOf/memberOfRequestBuilder';
import {DirectoryObjectItemRequestBuilder as ia2fb21118e189a4030f57a855cd22ec4c9ef795f2a70375686826c978e10da80} from './registeredOwners/item/directoryObjectItemRequestBuilder';
import {RegisteredOwnersRequestBuilder} from './registeredOwners/registeredOwnersRequestBuilder';
import {DirectoryObjectItemRequestBuilder as i7b986fea6bdb8b694e57080774265b5af0926cfec4bac4ca4593161ac40f8cf7} from './registeredUsers/item/directoryObjectItemRequestBuilder';
import {RegisteredUsersRequestBuilder} from './registeredUsers/registeredUsersRequestBuilder';
import {RestoreRequestBuilder} from './restore/restoreRequestBuilder';
import {DirectoryObjectItemRequestBuilder as ic349859a689532e26b3a877c695090185628fb06d37c41b9861a3b79bc8298d7} from './transitiveMemberOf/item/directoryObjectItemRequestBuilder';
...
export class DeviceRequestBuilder {
     ...
     */
    public memberOfById(id: string) : iad13a205c6b54646aac3aaf517cb4e2badd50fbbe56a0e14b8b331388759bbf4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["directoryObject%2Did"] = id
        return new iad13a205c6b54646aac3aaf517cb4e2badd50fbbe56a0e14b8b331388759bbf4(urlTplParams, this.requestAdapter);
    };
    /**
     * Update the navigation property device in users
     * @param body 
     ...
     * @returns a DirectoryObjectItemRequestBuilder
     */
    public registeredOwnersById(id: string) : ia2fb21118e189a4030f57a855cd22ec4c9ef795f2a70375686826c978e10da80 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["directoryObject%2Did"] = id
        return new ia2fb21118e189a4030f57a855cd22ec4c9ef795f2a70375686826c978e10da80(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the registeredUsers property of the microsoft.graph.device entity.
     * @param id Unique identifier of the item
     * @returns a DirectoryObjectItemRequestBuilder
     */
    public registeredUsersById(id: string) : i7b986fea6bdb8b694e57080774265b5af0926cfec4bac4ca4593161ac40f8cf7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["directoryObject%2Did"] = id
        return new i7b986fea6bdb8b694e57080774265b5af0926cfec4bac4ca4593161ac40f8cf7(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the transitiveMemberOf property of the microsoft.graph.device entity.
     * @param id Unique identifier of the item
     * @returns a DirectoryObjectItemRequestBuilder
     */
    public transitiveMemberOfById(id: string) : ic349859a689532e26b3a877c695090185628fb06d37c41b9861a3b79bc8298d7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["directoryObject%2Did"] = id
        return new ic349859a689532e26b3a877c695090185628fb06d37c41b9861a3b79bc8298d7(urlTplParams, this.requestAdapter);
    };
}
