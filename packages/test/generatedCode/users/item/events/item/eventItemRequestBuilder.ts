...
import {EventItemRequestBuilder as iebe9cf74465941c4b10eca4cc1b85651605856ca189e5bb4e39722bab4abbaae} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : iebe9cf74465941c4b10eca4cc1b85651605856ca189e5bb4e39722bab4abbaae {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new iebe9cf74465941c4b10eca4cc1b85651605856ca189e5bb4e39722bab4abbaae(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
