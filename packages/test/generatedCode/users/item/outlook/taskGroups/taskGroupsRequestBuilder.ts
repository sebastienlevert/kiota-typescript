import {OutlookTaskGroup, OutlookTaskGroupCollectionResponse} from '../../../../models/';
import {createOutlookTaskGroupCollectionResponseFromDiscriminatorValue} from '../../../../models/createOutlookTaskGroupCollectionResponseFromDiscriminatorValue';
import {createOutlookTaskGroupFromDiscriminatorValue} from '../../../../models/createOutlookTaskGroupFromDiscriminatorValue';
...
export class TaskGroupsRequestBuilder {
    ...
    public get(requestConfiguration?: TaskGroupsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OutlookTaskGroupCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OutlookTaskGroupCollectionResponse>(requestInfo, createOutlookTaskGroupCollectionResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create an Outlook task group in the user's mailbox.
     * @param body 
    ...
    public post(body: OutlookTaskGroup | undefined, requestConfiguration?: TaskGroupsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OutlookTaskGroup | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OutlookTaskGroup>(requestInfo, createOutlookTaskGroupFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('request adapter is null'));
    };
}
