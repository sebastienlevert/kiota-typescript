import {OutlookTask, OutlookTaskCollectionResponse} from '../../../../../../../../models/';
import {createOutlookTaskCollectionResponseFromDiscriminatorValue} from '../../../../../../../../models/createOutlookTaskCollectionResponseFromDiscriminatorValue';
...
export class TasksRequestBuilder {
    ...
    public get(requestConfiguration?: TasksRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<OutlookTaskCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<OutlookTaskCollectionResponse>(requestInfo, createOutlookTaskCollectionResponseFromDiscriminatorValue, responseHandler, undefined) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to tasks for users
     * @param body 
