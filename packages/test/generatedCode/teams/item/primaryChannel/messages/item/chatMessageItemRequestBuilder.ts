...
import {ChatMessageItemRequestBuilder as ic1fc3a568838ccc68ed6f3bba14985758494c3209b502beab2945a5d653f04b4} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : ic1fc3a568838ccc68ed6f3bba14985758494c3209b502beab2945a5d653f04b4 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new ic1fc3a568838ccc68ed6f3bba14985758494c3209b502beab2945a5d653f04b4(urlTplParams, this.requestAdapter);
    };
}
