...
import {ChannelItemRequestBuilder as i3e98a003f32ef0bcaff1e87292b7ef5e154d4456f4a756bb76fc1c7d6e1ebabb} from './allChannels/item/channelItemRequestBuilder';
...
import {ChannelItemRequestBuilder as i4252f534a22f028e998bd117515aa954d2eb93ae50b48d79fd3dd7f7e6f686ad} from './channels/item/channelItemRequestBuilder';
...
import {ChannelItemRequestBuilder as id8f579e02094c20d0330fd0fd7583a719cf5d2c49055b6424ae20721fd1c2623} from './incomingChannels/item/channelItemRequestBuilder';
...
export class TeamItemRequestBuilder {
     ...
     */
    public allChannelsById(id: string) : i3e98a003f32ef0bcaff1e87292b7ef5e154d4456f4a756bb76fc1c7d6e1ebabb {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new i3e98a003f32ef0bcaff1e87292b7ef5e154d4456f4a756bb76fc1c7d6e1ebabb(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the channels property of the microsoft.graph.team entity.
     * @param id Unique identifier of the item
     * @returns a ChannelItemRequestBuilder
     */
    public channelsById(id: string) : i4252f534a22f028e998bd117515aa954d2eb93ae50b48d79fd3dd7f7e6f686ad {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new i4252f534a22f028e998bd117515aa954d2eb93ae50b48d79fd3dd7f7e6f686ad(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a ChannelItemRequestBuilder
     */
    public incomingChannelsById(id: string) : id8f579e02094c20d0330fd0fd7583a719cf5d2c49055b6424ae20721fd1c2623 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new id8f579e02094c20d0330fd0fd7583a719cf5d2c49055b6424ae20721fd1c2623(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the installedApps property of the microsoft.graph.team entity.
     * @param id Unique identifier of the item
