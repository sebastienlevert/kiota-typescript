...
import {ChatMessageItemRequestBuilder as i70dda37f01444c1fd9f8141de984b7c3f18f3c4c0be8f9493205684bc789194d} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i70dda37f01444c1fd9f8141de984b7c3f18f3c4c0be8f9493205684bc789194d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i70dda37f01444c1fd9f8141de984b7c3f18f3c4c0be8f9493205684bc789194d(urlTplParams, this.requestAdapter);
    };
}
