...
import {deserializeIntoChatMessageCollectionResponse} from '../../../../../../../models/deserializeIntoChatMessageCollectionResponse';
import {ODataError} from '../../../../../../../models/oDataErrors/oDataError';
import {serializeChatMessage} from '../../../../../../../models/serializeChatMessage';
import {serializeChatMessageCollectionResponse} from '../../../../../../../models/serializeChatMessageCollectionResponse';
...
export class RepliesRequestBuilder {
    ...
    public get(requestConfiguration?: RepliesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ChatMessageCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ChatMessageCollectionResponse>(requestInfo,deserializeIntoChatMessageCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new reply to a chatMessage in a specified channel.
     * @param body 
