...
import {deserializeIntoExtensionPropertyCollectionResponse} from '../../../models/deserializeIntoExtensionPropertyCollectionResponse';
...
import {serializeExtensionPropertyCollectionResponse} from '../../../models/serializeExtensionPropertyCollectionResponse';
...
export class ExtensionPropertiesRequestBuilder {
    ...
    public get(requestConfiguration?: ExtensionPropertiesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ExtensionPropertyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ExtensionPropertyCollectionResponse>(requestInfo,deserializeIntoExtensionPropertyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new directory extension definition, represented by an extensionProperty object.
     * @param body 
