...
import {deserializeIntoRiskyUserHistoryItemCollectionResponse} from '../../../../models/deserializeIntoRiskyUserHistoryItemCollectionResponse';
...
import {serializeRiskyUserHistoryItemCollectionResponse} from '../../../../models/serializeRiskyUserHistoryItemCollectionResponse';
...
export class HistoryRequestBuilder {
    ...
    public get(requestConfiguration?: HistoryRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RiskyUserHistoryItemCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RiskyUserHistoryItemCollectionResponse>(requestInfo,deserializeIntoRiskyUserHistoryItemCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to history for identityProtection
     * @param body 
