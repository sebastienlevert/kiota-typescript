...
import {deserializeIntoRiskyUserCollectionResponse} from '../../models/deserializeIntoRiskyUserCollectionResponse';
...
import {serializeRiskyUserCollectionResponse} from '../../models/serializeRiskyUserCollectionResponse';
...
export class RiskyUsersRequestBuilder {
    ...
    public get(requestConfiguration?: RiskyUsersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RiskyUserCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RiskyUserCollectionResponse>(requestInfo,deserializeIntoRiskyUserCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to riskyUsers for identityProtection
     * @param body 
