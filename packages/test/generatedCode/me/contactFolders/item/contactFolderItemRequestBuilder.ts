...
import {ContactFolderItemRequestBuilder as ifbb7e1ebcc12db5b5be04a03884221ea0bf32fcfdd3a5eeef155b1e199bdeeb8} from './childFolders/item/contactFolderItemRequestBuilder';
...
export class ContactFolderItemRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : ifbb7e1ebcc12db5b5be04a03884221ea0bf32fcfdd3a5eeef155b1e199bdeeb8 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contactFolder%2Did1"] = id
        return new ifbb7e1ebcc12db5b5be04a03884221ea0bf32fcfdd3a5eeef155b1e199bdeeb8(urlTplParams, this.requestAdapter);
    };
    /**
