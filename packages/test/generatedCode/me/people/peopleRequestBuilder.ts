import {deserializeIntoPersonCollectionResponse} from '../../models/deserializeIntoPersonCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {PersonCollectionResponse} from '../../models/personCollectionResponse';
import {serializePersonCollectionResponse} from '../../models/serializePersonCollectionResponse';
...
export class PeopleRequestBuilder {
    ...
    public get(requestConfiguration?: PeopleRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PersonCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PersonCollectionResponse>(requestInfo,deserializeIntoPersonCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
