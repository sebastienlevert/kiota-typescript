...
import {EventItemRequestBuilder as i8181a1334920dc85eaf859dfae8c510ec86233729a1ad6a4769bf86ac32375e5} from './calendarView/item/eventItemRequestBuilder';
import {EventsRequestBuilder} from './events/eventsRequestBuilder';
import {EventItemRequestBuilder as i4a5e5aa197ea3f8b762e7dc1c0c28c6d0a1249da03a7e82fbd946ace4481225a} from './events/item/eventItemRequestBuilder';
...
export class CalendarItemRequestBuilder {
     ...
     */
    public calendarViewById(id: string) : i8181a1334920dc85eaf859dfae8c510ec86233729a1ad6a4769bf86ac32375e5 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i8181a1334920dc85eaf859dfae8c510ec86233729a1ad6a4769bf86ac32375e5(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a EventItemRequestBuilder
     */
    public eventsById(id: string) : i4a5e5aa197ea3f8b762e7dc1c0c28c6d0a1249da03a7e82fbd946ace4481225a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did"] = id
        return new i4a5e5aa197ea3f8b762e7dc1c0c28c6d0a1249da03a7e82fbd946ace4481225a(urlTplParams, this.requestAdapter);
    };
    /**
     * The user's calendars. Read-only. Nullable.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
