...
import {EventItemRequestBuilder as i9ee882de811eecd517f3e1713bbb2db1b9ea0881bfda52a4c39cd5b25e89359d} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i9ee882de811eecd517f3e1713bbb2db1b9ea0881bfda52a4c39cd5b25e89359d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i9ee882de811eecd517f3e1713bbb2db1b9ea0881bfda52a4c39cd5b25e89359d(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
