...
import {EventItemRequestBuilder as i4d3db891b46153e708073b4e89c98408733caf2ec7f4f8c1cf1a65f75589bfca} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i4d3db891b46153e708073b4e89c98408733caf2ec7f4f8c1cf1a65f75589bfca {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i4d3db891b46153e708073b4e89c98408733caf2ec7f4f8c1cf1a65f75589bfca(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
