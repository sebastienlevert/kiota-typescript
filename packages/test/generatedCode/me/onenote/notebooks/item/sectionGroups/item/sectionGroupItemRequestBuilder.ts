...
import {SectionGroupItemRequestBuilder as if6a620351a2849c32cd99630d04a1e9058da355cf199df9c29529e526449c652} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : if6a620351a2849c32cd99630d04a1e9058da355cf199df9c29529e526449c652 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new if6a620351a2849c32cd99630d04a1e9058da355cf199df9c29529e526449c652(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
