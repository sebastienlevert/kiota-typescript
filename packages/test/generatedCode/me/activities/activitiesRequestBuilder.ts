...
import {deserializeIntoUserActivityCollectionResponse} from '../../models/deserializeIntoUserActivityCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeUserActivity} from '../../models/serializeUserActivity';
import {serializeUserActivityCollectionResponse} from '../../models/serializeUserActivityCollectionResponse';
...
export class ActivitiesRequestBuilder {
    ...
    public get(requestConfiguration?: ActivitiesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserActivityCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UserActivityCollectionResponse>(requestInfo,deserializeIntoUserActivityCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to activities for me
     * @param body 
    ...
    public post(body: UserActivity | undefined, requestConfiguration?: ActivitiesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UserActivity | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UserActivity>(requestInfo,deserializeIntoUserActivity, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
