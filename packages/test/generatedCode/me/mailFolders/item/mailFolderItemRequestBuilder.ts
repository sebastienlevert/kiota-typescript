...
import {MailFolderItemRequestBuilder as ic400d5e6e24d879cdca0fc2b6b6a8618319671cf8a674aa0c9b640ad39d03d2f} from './childFolders/item/mailFolderItemRequestBuilder';
...
export class MailFolderItemRequestBuilder {
     ...
     */
    public childFoldersById(id: string) : ic400d5e6e24d879cdca0fc2b6b6a8618319671cf8a674aa0c9b640ad39d03d2f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["mailFolder%2Did1"] = id
        return new ic400d5e6e24d879cdca0fc2b6b6a8618319671cf8a674aa0c9b640ad39d03d2f(urlTplParams, this.requestAdapter);
    };
    /**
