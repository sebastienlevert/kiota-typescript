...
import {serializeRevokeSignInSessionsResponse} from './serializeRevokeSignInSessionsResponse';
...
export class RevokeSignInSessionsRequestBuilder {
    ...
    public post(requestConfiguration?: RevokeSignInSessionsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RevokeSignInSessionsResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RevokeSignInSessionsResponse>(requestInfo,deserializeIntoRevokeSignInSessionsResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
