...
import {EventItemRequestBuilder as ide2230aeb756871b18283af0148cd4ed75912e590ff7ae5891f42079dea1fcce} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ide2230aeb756871b18283af0148cd4ed75912e590ff7ae5891f42079dea1fcce {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new ide2230aeb756871b18283af0148cd4ed75912e590ff7ae5891f42079dea1fcce(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
