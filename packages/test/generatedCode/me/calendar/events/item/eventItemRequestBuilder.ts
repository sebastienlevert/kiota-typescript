...
import {EventItemRequestBuilder as i042460e6c52ba4711d37e4d24a1c591432fe4c3c5ac86edff685fbf7b3d6ac59} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i042460e6c52ba4711d37e4d24a1c591432fe4c3c5ac86edff685fbf7b3d6ac59 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i042460e6c52ba4711d37e4d24a1c591432fe4c3c5ac86edff685fbf7b3d6ac59(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
