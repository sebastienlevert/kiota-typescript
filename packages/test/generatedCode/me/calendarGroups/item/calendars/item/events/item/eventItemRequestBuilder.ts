...
import {EventItemRequestBuilder as id191f3de04baa8f6fa951efcf4e55c38ba69a93693e73d90b86980d5a7ade19d} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : id191f3de04baa8f6fa951efcf4e55c38ba69a93693e73d90b86980d5a7ade19d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new id191f3de04baa8f6fa951efcf4e55c38ba69a93693e73d90b86980d5a7ade19d(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
