...
import {EventItemRequestBuilder as i482c087da6696a76ab626ac0c5319a8ddf2287d136a60ab1ee45ed6219b791e1} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i482c087da6696a76ab626ac0c5319a8ddf2287d136a60ab1ee45ed6219b791e1 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i482c087da6696a76ab626ac0c5319a8ddf2287d136a60ab1ee45ed6219b791e1(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
