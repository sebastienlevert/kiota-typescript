...
import {EventItemRequestBuilder as ia11f979669ba9a2fd55557dcd0bd473677b33ae11edd2053179a4859274e9ac2} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ia11f979669ba9a2fd55557dcd0bd473677b33ae11edd2053179a4859274e9ac2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new ia11f979669ba9a2fd55557dcd0bd473677b33ae11edd2053179a4859274e9ac2(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
