...
import {deserializeIntoTemporaryAccessPassAuthenticationMethodCollectionResponse} from '../../../models/deserializeIntoTemporaryAccessPassAuthenticationMethodCollectionResponse';
...
import {serializeTemporaryAccessPassAuthenticationMethodCollectionResponse} from '../../../models/serializeTemporaryAccessPassAuthenticationMethodCollectionResponse';
import {TemporaryAccessPassAuthenticationMethod} from '../../../models/temporaryAccessPassAuthenticationMethod';
import {TemporaryAccessPassAuthenticationMethodCollectionResponse} from '../../../models/temporaryAccessPassAuthenticationMethodCollectionResponse';
...
export class TemporaryAccessPassMethodsRequestBuilder {
    ...
    public get(requestConfiguration?: TemporaryAccessPassMethodsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<TemporaryAccessPassAuthenticationMethodCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<TemporaryAccessPassAuthenticationMethodCollectionResponse>(requestInfo,deserializeIntoTemporaryAccessPassAuthenticationMethodCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new temporaryAccessPassAuthenticationMethod object on a user. A user can only have one Temporary Access Pass that's usable within its specified lifetime. If the user requires a new Temporary Access Pass while the current Temporary Access Pass is valid, the admin can create a new Temporary Access Pass for the user, the previous Temporary Access Pass will be deleted, and a new Temporary Access Pass will be created.
     * @param body 
