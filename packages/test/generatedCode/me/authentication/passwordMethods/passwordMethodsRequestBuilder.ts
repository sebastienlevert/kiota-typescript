...
import {deserializeIntoPasswordAuthenticationMethodCollectionResponse} from '../../../models/deserializeIntoPasswordAuthenticationMethodCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {PasswordAuthenticationMethod} from '../../../models/passwordAuthenticationMethod';
import {PasswordAuthenticationMethodCollectionResponse} from '../../../models/passwordAuthenticationMethodCollectionResponse';
import {serializePasswordAuthenticationMethod} from '../../../models/serializePasswordAuthenticationMethod';
import {serializePasswordAuthenticationMethodCollectionResponse} from '../../../models/serializePasswordAuthenticationMethodCollectionResponse';
...
export class PasswordMethodsRequestBuilder {
    ...
    public get(requestConfiguration?: PasswordMethodsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PasswordAuthenticationMethodCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PasswordAuthenticationMethodCollectionResponse>(requestInfo,deserializeIntoPasswordAuthenticationMethodCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to passwordMethods for me
     * @param body 
