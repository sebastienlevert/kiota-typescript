...
import {ChatMessageItemRequestBuilder as i1a4277a49f415846dcef5ceeecf8e45bf6f8094e4cad5cc46d571b0e74c96766} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i1a4277a49f415846dcef5ceeecf8e45bf6f8094e4cad5cc46d571b0e74c96766 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i1a4277a49f415846dcef5ceeecf8e45bf6f8094e4cad5cc46d571b0e74c96766(urlTplParams, this.requestAdapter);
    };
}
