...
import {AssociatedTeamInfoCollectionResponse} from '../../../models/associatedTeamInfoCollectionResponse';
import {deserializeIntoAssociatedTeamInfo} from '../../../models/deserializeIntoAssociatedTeamInfo';
import {deserializeIntoAssociatedTeamInfoCollectionResponse} from '../../../models/deserializeIntoAssociatedTeamInfoCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeAssociatedTeamInfo} from '../../../models/serializeAssociatedTeamInfo';
import {serializeAssociatedTeamInfoCollectionResponse} from '../../../models/serializeAssociatedTeamInfoCollectionResponse';
...
export class AssociatedTeamsRequestBuilder {
    ...
    public get(requestConfiguration?: AssociatedTeamsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AssociatedTeamInfoCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AssociatedTeamInfoCollectionResponse>(requestInfo,deserializeIntoAssociatedTeamInfoCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to associatedTeams for me
     * @param body 
