...
import {ChatMessageItemRequestBuilder as i7d194ff2ad5259bd4f2eb2c420ab978a5de9b1914f18b3f8e5871de4620a01c6} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i7d194ff2ad5259bd4f2eb2c420ab978a5de9b1914f18b3f8e5871de4620a01c6 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i7d194ff2ad5259bd4f2eb2c420ab978a5de9b1914f18b3f8e5871de4620a01c6(urlTplParams, this.requestAdapter);
    };
}
