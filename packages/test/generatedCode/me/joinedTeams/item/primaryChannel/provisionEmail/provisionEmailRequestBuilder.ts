import {deserializeIntoProvisionChannelEmailResult} from '../../../../../models/deserializeIntoProvisionChannelEmailResult';
import {ODataError} from '../../../../../models/oDataErrors/oDataError';
import {ProvisionChannelEmailResult} from '../../../../../models/provisionChannelEmailResult';
import {serializeProvisionChannelEmailResult} from '../../../../../models/serializeProvisionChannelEmailResult';
...
export class ProvisionEmailRequestBuilder {
    ...
    public post(requestConfiguration?: ProvisionEmailRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ProvisionChannelEmailResult | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ProvisionChannelEmailResult>(requestInfo,deserializeIntoProvisionChannelEmailResult, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
