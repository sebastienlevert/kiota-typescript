...
import {ChatMessageItemRequestBuilder as i24176c0c512d097db2506a89faa8a9cf627c0f436cb13a7c622bf6ce4975d607} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i24176c0c512d097db2506a89faa8a9cf627c0f436cb13a7c622bf6ce4975d607 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i24176c0c512d097db2506a89faa8a9cf627c0f436cb13a7c622bf6ce4975d607(urlTplParams, this.requestAdapter);
    };
}
