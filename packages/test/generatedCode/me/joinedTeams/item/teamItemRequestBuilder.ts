...
import {ChannelItemRequestBuilder as i05a02727186fa34872d2a194158b15e21f22ac43c5dbf6184d873133e83a14f7} from './allChannels/item/channelItemRequestBuilder';
...
import {ChannelItemRequestBuilder as i22e2f0290d3cbd1485b01ab8a95f6a1f9b9d165e694bcb2ca123a96a32f60734} from './channels/item/channelItemRequestBuilder';
...
import {ChannelItemRequestBuilder as i66b3f4349993556501f6025709b5ee37f8b1c03d088d6eeaaa7b84fec6a6121b} from './incomingChannels/item/channelItemRequestBuilder';
...
export class TeamItemRequestBuilder {
     ...
     */
    public allChannelsById(id: string) : i05a02727186fa34872d2a194158b15e21f22ac43c5dbf6184d873133e83a14f7 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new i05a02727186fa34872d2a194158b15e21f22ac43c5dbf6184d873133e83a14f7(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the channels property of the microsoft.graph.team entity.
     * @param id Unique identifier of the item
     * @returns a ChannelItemRequestBuilder
     */
    public channelsById(id: string) : i22e2f0290d3cbd1485b01ab8a95f6a1f9b9d165e694bcb2ca123a96a32f60734 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new i22e2f0290d3cbd1485b01ab8a95f6a1f9b9d165e694bcb2ca123a96a32f60734(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a ChannelItemRequestBuilder
     */
    public incomingChannelsById(id: string) : i66b3f4349993556501f6025709b5ee37f8b1c03d088d6eeaaa7b84fec6a6121b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["channel%2Did"] = id
        return new i66b3f4349993556501f6025709b5ee37f8b1c03d088d6eeaaa7b84fec6a6121b(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the installedApps property of the microsoft.graph.team entity.
     * @param id Unique identifier of the item
