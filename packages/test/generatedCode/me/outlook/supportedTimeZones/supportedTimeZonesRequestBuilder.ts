...
import {serializeSupportedTimeZonesResponse} from './serializeSupportedTimeZonesResponse';
...
export class SupportedTimeZonesRequestBuilder {
    ...
    public get(requestConfiguration?: SupportedTimeZonesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SupportedTimeZonesResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SupportedTimeZonesResponse>(requestInfo,deserializeIntoSupportedTimeZonesResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
