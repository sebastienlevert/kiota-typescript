...
import {EventItemRequestBuilder as ibbc9d52225899199774305812389b74eb046759797392dcc5ab5cceef5261bed} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ibbc9d52225899199774305812389b74eb046759797392dcc5ab5cceef5261bed {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new ibbc9d52225899199774305812389b74eb046759797392dcc5ab5cceef5261bed(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
