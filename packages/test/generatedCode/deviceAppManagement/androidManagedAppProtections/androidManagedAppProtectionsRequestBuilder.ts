...
import {deserializeIntoAndroidManagedAppProtectionCollectionResponse} from '../../models/deserializeIntoAndroidManagedAppProtectionCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeAndroidManagedAppProtection} from '../../models/serializeAndroidManagedAppProtection';
import {serializeAndroidManagedAppProtectionCollectionResponse} from '../../models/serializeAndroidManagedAppProtectionCollectionResponse';
...
export class AndroidManagedAppProtectionsRequestBuilder {
    ...
    public get(requestConfiguration?: AndroidManagedAppProtectionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AndroidManagedAppProtectionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AndroidManagedAppProtectionCollectionResponse>(requestInfo,deserializeIntoAndroidManagedAppProtectionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to androidManagedAppProtections for deviceAppManagement
     * @param body 
