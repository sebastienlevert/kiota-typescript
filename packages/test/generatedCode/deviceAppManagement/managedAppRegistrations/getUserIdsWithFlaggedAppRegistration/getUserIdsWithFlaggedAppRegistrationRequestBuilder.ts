...
import {serializeGetUserIdsWithFlaggedAppRegistrationResponse} from './serializeGetUserIdsWithFlaggedAppRegistrationResponse';
...
export class GetUserIdsWithFlaggedAppRegistrationRequestBuilder {
    ...
    public get(requestConfiguration?: GetUserIdsWithFlaggedAppRegistrationRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetUserIdsWithFlaggedAppRegistrationResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetUserIdsWithFlaggedAppRegistrationResponse>(requestInfo,deserializeIntoGetUserIdsWithFlaggedAppRegistrationResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
