import {deserializeIntoManagedMobileLobAppCollectionResponse} from '../../../models/deserializeIntoManagedMobileLobAppCollectionResponse';
import {ManagedMobileLobAppCollectionResponse} from '../../../models/managedMobileLobAppCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeManagedMobileLobAppCollectionResponse} from '../../../models/serializeManagedMobileLobAppCollectionResponse';
...
export class ManagedMobileLobAppRequestBuilder {
    ...
    public get(requestConfiguration?: ManagedMobileLobAppRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedMobileLobAppCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ManagedMobileLobAppCollectionResponse>(requestInfo,deserializeIntoManagedMobileLobAppCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
