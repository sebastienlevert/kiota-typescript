import {deserializeIntoManagedMobileLobApp} from '../../../../models/deserializeIntoManagedMobileLobApp';
import {ManagedMobileLobApp} from '../../../../models/managedMobileLobApp';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeManagedMobileLobApp} from '../../../../models/serializeManagedMobileLobApp';
...
export class ManagedMobileLobAppRequestBuilder {
    ...
    public get(requestConfiguration?: ManagedMobileLobAppRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ManagedMobileLobApp | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ManagedMobileLobApp>(requestInfo,deserializeIntoManagedMobileLobApp, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
