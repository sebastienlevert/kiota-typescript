...
export class MobileAppAssignmentItemRequestBuilder {
    ...
    public get(requestConfiguration?: MobileAppAssignmentItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<MobileAppAssignment | undefined> {
        ...
        return this.requestAdapter?.sendAsync<MobileAppAssignment>(requestInfo,deserializeIntoMobileAppAssignment, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the navigation property assignments in deviceAppManagement
     * @param body 
