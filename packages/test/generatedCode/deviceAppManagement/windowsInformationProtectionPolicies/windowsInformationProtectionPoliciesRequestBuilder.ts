...
import {deserializeIntoWindowsInformationProtectionPolicyCollectionResponse} from '../../models/deserializeIntoWindowsInformationProtectionPolicyCollectionResponse';
import {ODataError} from '../../models/oDataErrors/oDataError';
import {serializeWindowsInformationProtectionPolicy} from '../../models/serializeWindowsInformationProtectionPolicy';
import {serializeWindowsInformationProtectionPolicyCollectionResponse} from '../../models/serializeWindowsInformationProtectionPolicyCollectionResponse';
...
export class WindowsInformationProtectionPoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: WindowsInformationProtectionPoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WindowsInformationProtectionPolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WindowsInformationProtectionPolicyCollectionResponse>(requestInfo,deserializeIntoWindowsInformationProtectionPolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to windowsInformationProtectionPolicies for deviceAppManagement
     * @param body 
    ...
    public post(body: WindowsInformationProtectionPolicy | undefined, requestConfiguration?: WindowsInformationProtectionPoliciesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<WindowsInformationProtectionPolicy | undefined> {
        ...
        return this.requestAdapter?.sendAsync<WindowsInformationProtectionPolicy>(requestInfo,deserializeIntoWindowsInformationProtectionPolicy, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
