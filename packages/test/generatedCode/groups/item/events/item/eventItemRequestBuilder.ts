...
import {EventItemRequestBuilder as i45cbcb21bcc1f34cb5b0271a5ebad4ca0a5151f78afa2b1e36323e129b6a4f99} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i45cbcb21bcc1f34cb5b0271a5ebad4ca0a5151f78afa2b1e36323e129b6a4f99 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i45cbcb21bcc1f34cb5b0271a5ebad4ca0a5151f78afa2b1e36323e129b6a4f99(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
