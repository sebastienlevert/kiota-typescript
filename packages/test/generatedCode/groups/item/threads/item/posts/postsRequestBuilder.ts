import {deserializeIntoPostCollectionResponse} from '../../../../../models/deserializeIntoPostCollectionResponse';
import {ODataError} from '../../../../../models/oDataErrors/oDataError';
import {PostCollectionResponse} from '../../../../../models/postCollectionResponse';
import {serializePostCollectionResponse} from '../../../../../models/serializePostCollectionResponse';
...
export class PostsRequestBuilder {
    ...
    public get(requestConfiguration?: PostsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PostCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PostCollectionResponse>(requestInfo,deserializeIntoPostCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
