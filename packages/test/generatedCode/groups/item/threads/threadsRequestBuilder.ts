...
import {deserializeIntoConversationThreadCollectionResponse} from '../../../models/deserializeIntoConversationThreadCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeConversationThread} from '../../../models/serializeConversationThread';
import {serializeConversationThreadCollectionResponse} from '../../../models/serializeConversationThreadCollectionResponse';
...
export class ThreadsRequestBuilder {
    ...
    public get(requestConfiguration?: ThreadsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConversationThreadCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ConversationThreadCollectionResponse>(requestInfo,deserializeIntoConversationThreadCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Start a new group conversation by first creating a thread. A new conversation, conversation thread, and post are created in the group.Use reply thread or reply post to further post to that thread. Note: You can also start a new thread in an existing conversation.
     * @param body 
    ...
    public post(body: ConversationThread | undefined, requestConfiguration?: ThreadsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ConversationThread | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ConversationThread>(requestInfo,deserializeIntoConversationThread, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
