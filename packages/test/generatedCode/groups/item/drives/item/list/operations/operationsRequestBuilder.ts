...
import {deserializeIntoRichLongRunningOperationCollectionResponse} from '../../../../../../models/deserializeIntoRichLongRunningOperationCollectionResponse';
...
import {serializeRichLongRunningOperationCollectionResponse} from '../../../../../../models/serializeRichLongRunningOperationCollectionResponse';
...
export class OperationsRequestBuilder {
    ...
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<RichLongRunningOperationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<RichLongRunningOperationCollectionResponse>(requestInfo,deserializeIntoRichLongRunningOperationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to operations for groups
     * @param body 
