...
import {ContentTypeItemRequestBuilder as i3f15a8b59da9722c65a3c2e8f91c49b335aaca176520a74e94aff6de8703bfa0} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as i9de6337bb317f84dabd4fdf85fd52a1434f65f41c8b86f140ac636f875f7df0e} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i54e26e02aafcdd994ab2410b956c91349f34c945bbb6d4b1349eec53639f0d0f} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : i3f15a8b59da9722c65a3c2e8f91c49b335aaca176520a74e94aff6de8703bfa0 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new i3f15a8b59da9722c65a3c2e8f91c49b335aaca176520a74e94aff6de8703bfa0(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : i9de6337bb317f84dabd4fdf85fd52a1434f65f41c8b86f140ac636f875f7df0e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i9de6337bb317f84dabd4fdf85fd52a1434f65f41c8b86f140ac636f875f7df0e(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i54e26e02aafcdd994ab2410b956c91349f34c945bbb6d4b1349eec53639f0d0f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i54e26e02aafcdd994ab2410b956c91349f34c945bbb6d4b1349eec53639f0d0f(urlTplParams, this.requestAdapter);
    };
    /**
