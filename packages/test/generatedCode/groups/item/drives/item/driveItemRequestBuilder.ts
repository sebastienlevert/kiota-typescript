...
import {DriveItemItemRequestBuilder as iccfc6dcbdb64bc3d0a22c6c354ff54edcd63cd9661b4766a1af5951104c5d0fe} from './bundles/item/driveItemItemRequestBuilder';
...
import {DriveItemItemRequestBuilder as ic7d63a703f14011bff15eb81c1f17faa49ca9a1b06b9b348b6704c73565480de} from './following/item/driveItemItemRequestBuilder';
import {DriveItemItemRequestBuilder as i20f0a8d6b5467ec165a5441714bb22d5b99294a9a6b512c1d02127a9b3becabf} from './items/item/driveItemItemRequestBuilder';
...
import {DriveItemItemRequestBuilder as i01df0edc3c266d81512e3d1827f5e11edc84a1c779a50ac3bf284d99fd828c42} from './special/item/driveItemItemRequestBuilder';
...
export class DriveItemRequestBuilder {
     ...
     */
    public bundlesById(id: string) : iccfc6dcbdb64bc3d0a22c6c354ff54edcd63cd9661b4766a1af5951104c5d0fe {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did"] = id
        return new iccfc6dcbdb64bc3d0a22c6c354ff54edcd63cd9661b4766a1af5951104c5d0fe(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a DriveItemItemRequestBuilder
     */
    public followingById(id: string) : ic7d63a703f14011bff15eb81c1f17faa49ca9a1b06b9b348b6704c73565480de {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did"] = id
        return new ic7d63a703f14011bff15eb81c1f17faa49ca9a1b06b9b348b6704c73565480de(urlTplParams, this.requestAdapter);
    };
    /**
     * The group's drives. Read-only.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns a DriveItemItemRequestBuilder
     */
    public itemsById(id: string) : i20f0a8d6b5467ec165a5441714bb22d5b99294a9a6b512c1d02127a9b3becabf {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did"] = id
        return new i20f0a8d6b5467ec165a5441714bb22d5b99294a9a6b512c1d02127a9b3becabf(urlTplParams, this.requestAdapter);
    };
    /**
     * Update the navigation property drives in groups
     * @param body 
     ...
     * @returns a DriveItemItemRequestBuilder
     */
    public specialById(id: string) : i01df0edc3c266d81512e3d1827f5e11edc84a1c779a50ac3bf284d99fd828c42 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did"] = id
        return new i01df0edc3c266d81512e3d1827f5e11edc84a1c779a50ac3bf284d99fd828c42(urlTplParams, this.requestAdapter);
    };
}
