...
import {DriveItemItemRequestBuilder as iec4ee055b5452078d9fb2884245e30cab579e9aa2d07dfa2792e05e1b139ef06} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : iec4ee055b5452078d9fb2884245e30cab579e9aa2d07dfa2792e05e1b139ef06 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did1"] = id
        return new iec4ee055b5452078d9fb2884245e30cab579e9aa2d07dfa2792e05e1b139ef06(urlTplParams, this.requestAdapter);
    };
    /**
