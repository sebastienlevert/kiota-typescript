...
import {TermItemRequestBuilder as i547d2ae7ad1fa475bde070010e36f30bf4550211cd6bf111eaa239b8d36d984e} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i547d2ae7ad1fa475bde070010e36f30bf4550211cd6bf111eaa239b8d36d984e {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i547d2ae7ad1fa475bde070010e36f30bf4550211cd6bf111eaa239b8d36d984e(urlTplParams, this.requestAdapter);
    };
    /**
