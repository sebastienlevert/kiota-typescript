...
import {TermItemRequestBuilder as id13b9443c1701ce963b6bb32379af99cbf99de1874b92b07148c2f1630b306dd} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : id13b9443c1701ce963b6bb32379af99cbf99de1874b92b07148c2f1630b306dd {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new id13b9443c1701ce963b6bb32379af99cbf99de1874b92b07148c2f1630b306dd(urlTplParams, this.requestAdapter);
    };
    /**
