...
import {TermItemRequestBuilder as i10e6cf065e0fb622d0cfd797e0f16457f6e1536001c9622a1a728f00385a9424} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i10e6cf065e0fb622d0cfd797e0f16457f6e1536001c9622a1a728f00385a9424 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i10e6cf065e0fb622d0cfd797e0f16457f6e1536001c9622a1a728f00385a9424(urlTplParams, this.requestAdapter);
    };
    /**
