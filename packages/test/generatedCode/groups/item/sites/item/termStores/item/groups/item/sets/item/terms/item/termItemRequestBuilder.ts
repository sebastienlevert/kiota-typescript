...
import {TermItemRequestBuilder as i9e5a93039486e978c10629cb74d613f0f6d573ffca32235d630d309d153f5b55} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i9e5a93039486e978c10629cb74d613f0f6d573ffca32235d630d309d153f5b55 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i9e5a93039486e978c10629cb74d613f0f6d573ffca32235d630d309d153f5b55(urlTplParams, this.requestAdapter);
    };
    /**
