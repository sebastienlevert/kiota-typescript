...
import {TermItemRequestBuilder as i53672100ba002903ba76605d1e8509ef235f97f9befd84d0fcee6ce83b1648cc} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as i4ab761494001221bcf91ec936a79f824b858486c2e46a09d1d3936ac7b00e4b1} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i53672100ba002903ba76605d1e8509ef235f97f9befd84d0fcee6ce83b1648cc {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i53672100ba002903ba76605d1e8509ef235f97f9befd84d0fcee6ce83b1648cc(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : i4ab761494001221bcf91ec936a79f824b858486c2e46a09d1d3936ac7b00e4b1 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i4ab761494001221bcf91ec936a79f824b858486c2e46a09d1d3936ac7b00e4b1(urlTplParams, this.requestAdapter);
    };
}
