...
import {TermItemRequestBuilder as id9965553adc37bc0194e1d56d81bd94d789af0395beab75072de26c264c49207} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : id9965553adc37bc0194e1d56d81bd94d789af0395beab75072de26c264c49207 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new id9965553adc37bc0194e1d56d81bd94d789af0395beab75072de26c264c49207(urlTplParams, this.requestAdapter);
    };
    /**
