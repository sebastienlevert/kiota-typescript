...
import {deserializeIntoBaseItem} from '../../../../../../models/deserializeIntoBaseItem';
import {ODataError} from '../../../../../../models/oDataErrors/oDataError';
import {serializeBaseItem} from '../../../../../../models/serializeBaseItem';
...
export class BaseItemItemRequestBuilder {
    ...
    public get(requestConfiguration?: BaseItemItemRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<BaseItem | undefined> {
        ...
        return this.requestAdapter?.sendAsync<BaseItem>(requestInfo,deserializeIntoBaseItem, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
