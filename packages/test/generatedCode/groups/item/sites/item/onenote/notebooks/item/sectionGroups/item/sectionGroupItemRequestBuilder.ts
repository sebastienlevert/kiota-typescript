...
import {SectionGroupItemRequestBuilder as i398dc29057cd31e0ca93005f1dbd23598389db5899a94d60bc10dc7a5ad80f38} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i398dc29057cd31e0ca93005f1dbd23598389db5899a94d60bc10dc7a5ad80f38 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new i398dc29057cd31e0ca93005f1dbd23598389db5899a94d60bc10dc7a5ad80f38(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
