...
import {ContentTypeItemRequestBuilder as i52f4600afd53c6949f0798343f77b3710434faf6736598d3f652571eb26fb621} from './baseTypes/item/contentTypeItemRequestBuilder';
...
import {ColumnDefinitionItemRequestBuilder as icb9d38738aa6b200b1239ab2142f4d0886bceeb632960881e33f825f309ce674} from './columnPositions/item/columnDefinitionItemRequestBuilder';
import {ColumnsRequestBuilder} from './columns/columnsRequestBuilder';
import {ColumnDefinitionItemRequestBuilder as i7fbfe7bd2e403b1d4d0dd6afdb751bf5e29d9335a201d9a47319583adb044bcd} from './columns/item/columnDefinitionItemRequestBuilder';
...
export class ContentTypeItemRequestBuilder {
     ...
     */
    public baseTypesById(id: string) : i52f4600afd53c6949f0798343f77b3710434faf6736598d3f652571eb26fb621 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["contentType%2Did1"] = id
        return new i52f4600afd53c6949f0798343f77b3710434faf6736598d3f652571eb26fb621(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     ...
     */
    public columnPositionsById(id: string) : icb9d38738aa6b200b1239ab2142f4d0886bceeb632960881e33f825f309ce674 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new icb9d38738aa6b200b1239ab2142f4d0886bceeb632960881e33f825f309ce674(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the columns property of the microsoft.graph.contentType entity.
     * @param id Unique identifier of the item
     * @returns a ColumnDefinitionItemRequestBuilder
     */
    public columnsById(id: string) : i7fbfe7bd2e403b1d4d0dd6afdb751bf5e29d9335a201d9a47319583adb044bcd {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["columnDefinition%2Did"] = id
        return new i7fbfe7bd2e403b1d4d0dd6afdb751bf5e29d9335a201d9a47319583adb044bcd(urlTplParams, this.requestAdapter);
    };
    /**
