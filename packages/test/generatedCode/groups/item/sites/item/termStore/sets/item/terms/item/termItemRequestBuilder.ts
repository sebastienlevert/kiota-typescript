...
import {TermItemRequestBuilder as i884691e6892a8d4868aaa4214c99dc039fdde44f21cab7760880a78bdfb7397f} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i884691e6892a8d4868aaa4214c99dc039fdde44f21cab7760880a78bdfb7397f {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i884691e6892a8d4868aaa4214c99dc039fdde44f21cab7760880a78bdfb7397f(urlTplParams, this.requestAdapter);
    };
    /**
