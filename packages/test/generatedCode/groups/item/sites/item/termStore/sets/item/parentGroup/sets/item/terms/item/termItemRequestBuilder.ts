...
import {TermItemRequestBuilder as ib94469ef04d277eadeed24d0f09ba4d8af157d436d624b3eff2bad0de78e0103} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : ib94469ef04d277eadeed24d0f09ba4d8af157d436d624b3eff2bad0de78e0103 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new ib94469ef04d277eadeed24d0f09ba4d8af157d436d624b3eff2bad0de78e0103(urlTplParams, this.requestAdapter);
    };
    /**
