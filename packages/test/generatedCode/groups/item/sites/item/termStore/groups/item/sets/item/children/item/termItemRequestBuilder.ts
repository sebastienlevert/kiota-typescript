...
import {TermItemRequestBuilder as i756b70b9f76ad24c9418252b7b5a019ffdc5aef85785adf15153edaa5e162c03} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i756b70b9f76ad24c9418252b7b5a019ffdc5aef85785adf15153edaa5e162c03 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i756b70b9f76ad24c9418252b7b5a019ffdc5aef85785adf15153edaa5e162c03(urlTplParams, this.requestAdapter);
    };
    /**
