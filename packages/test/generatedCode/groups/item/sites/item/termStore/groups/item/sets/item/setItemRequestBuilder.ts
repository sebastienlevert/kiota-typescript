...
import {TermItemRequestBuilder as i8c89fda72e52880fe1d1d8e396e3736c4900734068aaee5813f2ee12e5c00cd2} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as i8297cdd2249b78bbbc24c11577b1683c8971a79b700d24f2283aac0c29329498} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i8c89fda72e52880fe1d1d8e396e3736c4900734068aaee5813f2ee12e5c00cd2 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i8c89fda72e52880fe1d1d8e396e3736c4900734068aaee5813f2ee12e5c00cd2(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : i8297cdd2249b78bbbc24c11577b1683c8971a79b700d24f2283aac0c29329498 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i8297cdd2249b78bbbc24c11577b1683c8971a79b700d24f2283aac0c29329498(urlTplParams, this.requestAdapter);
    };
}
