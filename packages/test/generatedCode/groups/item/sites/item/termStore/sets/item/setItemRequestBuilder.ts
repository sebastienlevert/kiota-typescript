...
import {TermItemRequestBuilder as i954174c88bc08531715ce699ce2eb7353ec546e12d17f913dd3d2429f49e940d} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as ic89e53599bb64f6ac529b5a787a1c099195783733f1688b23d8ac50196f1c958} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i954174c88bc08531715ce699ce2eb7353ec546e12d17f913dd3d2429f49e940d {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i954174c88bc08531715ce699ce2eb7353ec546e12d17f913dd3d2429f49e940d(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : ic89e53599bb64f6ac529b5a787a1c099195783733f1688b23d8ac50196f1c958 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new ic89e53599bb64f6ac529b5a787a1c099195783733f1688b23d8ac50196f1c958(urlTplParams, this.requestAdapter);
    };
}
