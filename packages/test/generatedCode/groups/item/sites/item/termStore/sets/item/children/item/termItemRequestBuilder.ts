...
import {TermItemRequestBuilder as i0a6ff052f0b947c286e6ed519b4b37f6745ae8e54379bfb41ef66fc4c3f60dcf} from './children/item/termItemRequestBuilder';
...
export class TermItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i0a6ff052f0b947c286e6ed519b4b37f6745ae8e54379bfb41ef66fc4c3f60dcf {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did1"] = id
        return new i0a6ff052f0b947c286e6ed519b4b37f6745ae8e54379bfb41ef66fc4c3f60dcf(urlTplParams, this.requestAdapter);
    };
    /**
