...
import {TermItemRequestBuilder as i817267abb0e15753f9d342888f168706acec567e3694bb1a2f1f68c4e13bdf8a} from './children/item/termItemRequestBuilder';
...
import {TermItemRequestBuilder as ib597b37ab1ce9a27cfc1a3aef0f87377ab30aff983bdde896bfada5de7a886e6} from './terms/item/termItemRequestBuilder';
...
export class SetItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i817267abb0e15753f9d342888f168706acec567e3694bb1a2f1f68c4e13bdf8a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new i817267abb0e15753f9d342888f168706acec567e3694bb1a2f1f68c4e13bdf8a(urlTplParams, this.requestAdapter);
    };
    /**
     ...
     * @returns a TermItemRequestBuilder
     */
    public termsById(id: string) : ib597b37ab1ce9a27cfc1a3aef0f87377ab30aff983bdde896bfada5de7a886e6 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["term%2Did"] = id
        return new ib597b37ab1ce9a27cfc1a3aef0f87377ab30aff983bdde896bfada5de7a886e6(urlTplParams, this.requestAdapter);
    };
}
