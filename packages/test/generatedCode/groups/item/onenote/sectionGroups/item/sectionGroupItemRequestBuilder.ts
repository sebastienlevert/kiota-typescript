...
import {SectionGroupItemRequestBuilder as ib966fbd851ec400f73d34f0cb45c7c24cde013f5088c3debaaa44607f797e041} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : ib966fbd851ec400f73d34f0cb45c7c24cde013f5088c3debaaa44607f797e041 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new ib966fbd851ec400f73d34f0cb45c7c24cde013f5088c3debaaa44607f797e041(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
