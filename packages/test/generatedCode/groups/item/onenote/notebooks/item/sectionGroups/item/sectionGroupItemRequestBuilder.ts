...
import {SectionGroupItemRequestBuilder as i17256036ffb952fbeb61931ba8a2170626a00194b58afd31fa345001e27545af} from './sectionGroups/item/sectionGroupItemRequestBuilder';
...
export class SectionGroupItemRequestBuilder {
     ...
     */
    public sectionGroupsById(id: string) : i17256036ffb952fbeb61931ba8a2170626a00194b58afd31fa345001e27545af {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["sectionGroup%2Did1"] = id
        return new i17256036ffb952fbeb61931ba8a2170626a00194b58afd31fa345001e27545af(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
     * @param id Unique identifier of the item
