...
import {ChatMessageItemRequestBuilder as i84d43d3820637647ee2d3a8fb1d1515fe59075784817507eecc38f4e2243f0ae} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : i84d43d3820637647ee2d3a8fb1d1515fe59075784817507eecc38f4e2243f0ae {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new i84d43d3820637647ee2d3a8fb1d1515fe59075784817507eecc38f4e2243f0ae(urlTplParams, this.requestAdapter);
    };
}
