...
import {ChatMessageItemRequestBuilder as id591a3107ab36059c11d416f1603e69673674bccba84caf63d6dfa845f75c255} from './replies/item/chatMessageItemRequestBuilder';
...
export class ChatMessageItemRequestBuilder {
     ...
     */
    public repliesById(id: string) : id591a3107ab36059c11d416f1603e69673674bccba84caf63d6dfa845f75c255 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["chatMessage%2Did1"] = id
        return new id591a3107ab36059c11d416f1603e69673674bccba84caf63d6dfa845f75c255(urlTplParams, this.requestAdapter);
    };
}
