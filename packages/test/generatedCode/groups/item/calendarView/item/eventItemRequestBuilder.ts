...
import {EventItemRequestBuilder as ib20e215ecf03a86632b21fbf7018f22bb027d3e6aa4490239b13f17eebe7becb} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : ib20e215ecf03a86632b21fbf7018f22bb027d3e6aa4490239b13f17eebe7becb {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new ib20e215ecf03a86632b21fbf7018f22bb027d3e6aa4490239b13f17eebe7becb(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
