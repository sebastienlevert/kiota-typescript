...
import {EventItemRequestBuilder as i89748b5ab500671b36701b779abf7cab71e1a54ee37ee909dd2e55b0657b9535} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : i89748b5ab500671b36701b779abf7cab71e1a54ee37ee909dd2e55b0657b9535 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new i89748b5ab500671b36701b779abf7cab71e1a54ee37ee909dd2e55b0657b9535(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
