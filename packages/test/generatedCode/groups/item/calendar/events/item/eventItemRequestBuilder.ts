...
import {EventItemRequestBuilder as idf40fc73bbe7eb260d5341f0a19d9e1afa29a1a63510772a30921b30c22fa394} from './instances/item/eventItemRequestBuilder';
...
export class EventItemRequestBuilder {
     ...
     */
    public instancesById(id: string) : idf40fc73bbe7eb260d5341f0a19d9e1afa29a1a63510772a30921b30c22fa394 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["event%2Did1"] = id
        return new idf40fc73bbe7eb260d5341f0a19d9e1afa29a1a63510772a30921b30c22fa394(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
     * @param id Unique identifier of the item
