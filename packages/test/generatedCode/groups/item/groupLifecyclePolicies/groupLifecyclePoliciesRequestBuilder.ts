...
import {deserializeIntoGroupLifecyclePolicyCollectionResponse} from '../../../models/deserializeIntoGroupLifecyclePolicyCollectionResponse';
...
import {serializeGroupLifecyclePolicyCollectionResponse} from '../../../models/serializeGroupLifecyclePolicyCollectionResponse';
...
export class GroupLifecyclePoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: GroupLifecyclePoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GroupLifecyclePolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GroupLifecyclePolicyCollectionResponse>(requestInfo,deserializeIntoGroupLifecyclePolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to groupLifecyclePolicies for groups
     * @param body 
