...
import {serializeCheckGrantedPermissionsForAppResponse} from './serializeCheckGrantedPermissionsForAppResponse';
...
export class CheckGrantedPermissionsForAppRequestBuilder {
    ...
    public post(requestConfiguration?: CheckGrantedPermissionsForAppRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CheckGrantedPermissionsForAppResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CheckGrantedPermissionsForAppResponse>(requestInfo,deserializeIntoCheckGrantedPermissionsForAppResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
