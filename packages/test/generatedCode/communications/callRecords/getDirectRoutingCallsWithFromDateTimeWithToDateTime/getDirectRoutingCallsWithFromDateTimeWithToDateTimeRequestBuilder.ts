...
import {serializeGetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse} from './serializeGetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse';
...
export class GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder {
    ...
    public get(requestConfiguration?: GetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse>(requestInfo,deserializeIntoGetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
