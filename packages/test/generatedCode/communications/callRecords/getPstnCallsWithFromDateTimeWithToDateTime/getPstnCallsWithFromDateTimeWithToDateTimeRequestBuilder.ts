...
import {serializeGetPstnCallsWithFromDateTimeWithToDateTimeResponse} from './serializeGetPstnCallsWithFromDateTimeWithToDateTimeResponse';
...
export class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder {
    ...
    public get(requestConfiguration?: GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<GetPstnCallsWithFromDateTimeWithToDateTimeResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<GetPstnCallsWithFromDateTimeWithToDateTimeResponse>(requestInfo,deserializeIntoGetPstnCallsWithFromDateTimeWithToDateTimeResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
