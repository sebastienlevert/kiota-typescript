...
export class UnmuteRequestBuilder {
    ...
    public post(body: UnmutePostRequestBody | undefined, requestConfiguration?: UnmuteRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<UnmuteParticipantOperation | undefined> {
        ...
        return this.requestAdapter?.sendAsync<UnmuteParticipantOperation>(requestInfo,deserializeIntoUnmuteParticipantOperation, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
