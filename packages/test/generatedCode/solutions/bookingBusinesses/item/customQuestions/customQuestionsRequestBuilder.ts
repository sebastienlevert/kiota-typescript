...
import {deserializeIntoBookingCustomQuestionCollectionResponse} from '../../../../models/deserializeIntoBookingCustomQuestionCollectionResponse';
import {ODataError} from '../../../../models/oDataErrors/oDataError';
import {serializeBookingCustomQuestion} from '../../../../models/serializeBookingCustomQuestion';
import {serializeBookingCustomQuestionCollectionResponse} from '../../../../models/serializeBookingCustomQuestionCollectionResponse';
...
export class CustomQuestionsRequestBuilder {
    ...
    public get(requestConfiguration?: CustomQuestionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<BookingCustomQuestionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<BookingCustomQuestionCollectionResponse>(requestInfo,deserializeIntoBookingCustomQuestionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new bookingCustomQuestion object.
     * @param body 
