...
import {deserializeIntoPrintTaskTriggerCollectionResponse} from '../../../../models/deserializeIntoPrintTaskTriggerCollectionResponse';
...
import {serializePrintTaskTriggerCollectionResponse} from '../../../../models/serializePrintTaskTriggerCollectionResponse';
...
export class TaskTriggersRequestBuilder {
    ...
    public get(requestConfiguration?: TaskTriggersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PrintTaskTriggerCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PrintTaskTriggerCollectionResponse>(requestInfo,deserializeIntoPrintTaskTriggerCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new task trigger on the specified printer. Currently, only **one** task trigger can be specified per printer, but this limit might be removed in the future. 
     * @param body 
