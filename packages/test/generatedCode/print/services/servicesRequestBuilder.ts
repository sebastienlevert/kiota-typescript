...
import {deserializeIntoPrintServiceCollectionResponse} from '../../models/deserializeIntoPrintServiceCollectionResponse';
...
import {serializePrintServiceCollectionResponse} from '../../models/serializePrintServiceCollectionResponse';
...
export class ServicesRequestBuilder {
    ...
    public get(requestConfiguration?: ServicesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<PrintServiceCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<PrintServiceCollectionResponse>(requestInfo,deserializeIntoPrintServiceCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to services for print
     * @param body 
