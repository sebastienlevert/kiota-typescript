...
import {deserializeIntoInternalDomainFederationCollectionResponse} from '../../../models/deserializeIntoInternalDomainFederationCollectionResponse';
...
import {serializeInternalDomainFederationCollectionResponse} from '../../../models/serializeInternalDomainFederationCollectionResponse';
...
export class FederationConfigurationRequestBuilder {
    ...
    public get(requestConfiguration?: FederationConfigurationRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<InternalDomainFederationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<InternalDomainFederationCollectionResponse>(requestInfo,deserializeIntoInternalDomainFederationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new internalDomainFederation object.
     * @param body 
    ...
    public post(body: InternalDomainFederation | undefined, requestConfiguration?: FederationConfigurationRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<InternalDomainFederation | undefined> {
        ...
        return this.requestAdapter?.sendAsync<InternalDomainFederation>(requestInfo,deserializeIntoInternalDomainFederation, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
