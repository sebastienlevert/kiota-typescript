...
import {serializeIsPublishedResponse} from './serializeIsPublishedResponse';
...
export class IsPublishedRequestBuilder {
    ...
    public get(requestConfiguration?: IsPublishedRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<IsPublishedResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<IsPublishedResponse>(requestInfo,deserializeIntoIsPublishedResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
