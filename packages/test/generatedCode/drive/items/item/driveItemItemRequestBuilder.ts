...
import {DriveItemItemRequestBuilder as i6146aa74e1d0eb629722e5201eaa57ea1ab7ce3098ab168e71560d879d8ac24a} from './children/item/driveItemItemRequestBuilder';
...
export class DriveItemItemRequestBuilder {
     ...
     */
    public childrenById(id: string) : i6146aa74e1d0eb629722e5201eaa57ea1ab7ce3098ab168e71560d879d8ac24a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["driveItem%2Did1"] = id
        return new i6146aa74e1d0eb629722e5201eaa57ea1ab7ce3098ab168e71560d879d8ac24a(urlTplParams, this.requestAdapter);
    };
    /**
