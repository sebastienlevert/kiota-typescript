...
import {deserializeIntoDriveItemVersionCollectionResponse} from '../../../../models/deserializeIntoDriveItemVersionCollectionResponse';
...
import {serializeDriveItemVersionCollectionResponse} from '../../../../models/serializeDriveItemVersionCollectionResponse';
...
export class VersionsRequestBuilder {
    ...
    public get(requestConfiguration?: VersionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DriveItemVersionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DriveItemVersionCollectionResponse>(requestInfo,deserializeIntoDriveItemVersionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to versions for drive
     * @param body 
