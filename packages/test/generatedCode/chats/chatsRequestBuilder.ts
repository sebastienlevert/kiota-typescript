...
import {deserializeIntoChatCollectionResponse} from '../models/deserializeIntoChatCollectionResponse';
import {ODataError} from '../models/oDataErrors/oDataError';
import {serializeChat} from '../models/serializeChat';
import {serializeChatCollectionResponse} from '../models/serializeChatCollectionResponse';
...
export class ChatsRequestBuilder {
    ...
    public get(requestConfiguration?: ChatsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ChatCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ChatCollectionResponse>(requestInfo,deserializeIntoChatCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
