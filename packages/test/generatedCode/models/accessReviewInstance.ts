import {createAccessReviewErrorFromDiscriminatorValue} from './createAccessReviewErrorFromDiscriminatorValue';
...
export class AccessReviewInstance extends Entity implements Parsable {
    ...
    private _definition?: AccessReviewScheduleDefinition | undefined;
    ...
    private _errors?: AccessReviewError[] | undefined;
     ...
     */
    public set definition(value: AccessReviewScheduleDefinition | undefined) {
     ...
     */
    public set errors(value: AccessReviewError[] | undefined) {
        this._errors = value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "definition": n => { this.definition = n.getObjectValue<AccessReviewScheduleDefinition>(createAccessReviewScheduleDefinitionFromDiscriminatorValue); },
            "endDateTime": n => { this.endDateTime = n.getDateValue(); },
            "errors": n => { this.errors = n.getCollectionOfObjectValues<AccessReviewError>(createAccessReviewErrorFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AccessReviewScheduleDefinition>("definition", this.definition);
        writer.writeDateValue("endDateTime", this.endDateTime);
        writer.writeCollectionOfObjectValues<AccessReviewError>("errors", this.errors);
