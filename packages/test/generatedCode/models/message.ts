...
import {createMentionsPreviewFromDiscriminatorValue} from './createMentionsPreviewFromDiscriminatorValue';
...
export class Message extends OutlookItem implements Parsable {
    ...
    private _mentionsPreview?: MentionsPreview | undefined;
    ...
    private _unsubscribeData?: string[] | undefined;
    /** The unsubscribeEnabled property */
    private _unsubscribeEnabled?: boolean | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "mentionsPreview": n => { this.mentionsPreview = n.getObjectValue<MentionsPreview>(createMentionsPreviewFromDiscriminatorValue); },
            ...
            "unsubscribeData": n => { this.unsubscribeData = n.getCollectionOfPrimitiveValues<string>(); },
            "unsubscribeEnabled": n => { this.unsubscribeEnabled = n.getBooleanValue(); },
     ...
     * @returns a mentionsPreview
     */
    public get mentionsPreview() {
        return this._mentionsPreview;
    };
    /**
     ...
     */
    public set mentionsPreview(value: MentionsPreview | undefined) {
        this._mentionsPreview = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<MentionsPreview>("mentionsPreview", this.mentionsPreview);
        ...
        writer.writeCollectionOfPrimitiveValues<string>("unsubscribeData", this.unsubscribeData);
     ...
     * @returns a string
     */
    public get unsubscribeData() {
        return this._unsubscribeData;
    };
    /**
     ...
     */
    public set unsubscribeData(value: string[] | undefined) {
        this._unsubscribeData = value;
    };
    /**
     * Gets the unsubscribeEnabled property value. The unsubscribeEnabled property
     * @returns a boolean
     */
    public get unsubscribeEnabled() {
        return this._unsubscribeEnabled;
    };
    /**
     ...
     */
    public set unsubscribeEnabled(value: boolean | undefined) {
        this._unsubscribeEnabled = value;
    };
    /**
