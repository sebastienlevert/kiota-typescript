...
export function serializeTeleconferenceDeviceMediaQuality(writer: SerializationWriter, teleconferenceDeviceMediaQuality: TeleconferenceDeviceMediaQuality | undefined = {}) : void {
