...
export function deserializeIntoMessageRuleActions(messageRuleActions: MessageRuleActions | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "forwardAsAttachmentTo": n => { messageRuleActions.forwardAsAttachmentTo = n.getCollectionOfObjectValues(deserializeIntoRecipient) as any ; },
        "forwardTo": n => { messageRuleActions.forwardTo = n.getCollectionOfObjectValues(deserializeIntoRecipient) as any ; },
        ...
        "redirectTo": n => { messageRuleActions.redirectTo = n.getCollectionOfObjectValues(deserializeIntoRecipient) as any ; },
