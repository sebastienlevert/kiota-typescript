...
export class OAuth2PermissionGrant extends Entity implements Parsable {
     ...
     */
    public set expiryTime(value: Date | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "expiryTime": n => { this.expiryTime = n.getDateValue(); },
            ...
            "startTime": n => { this.startTime = n.getDateValue(); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeDateValue("expiryTime", this.expiryTime);
