...
export function serializeWindowsProtectionState(writer: SerializationWriter, windowsProtectionState: WindowsProtectionState | undefined = {}) : void {
        serializeEntity(writer, windowsProtectionState)
            ...
            writer.writeCollectionOfObjectValuesFromMethod("detectedMalwareState", windowsProtectionState.detectedMalwareState as any, serializeWindowsDeviceMalwareState);
