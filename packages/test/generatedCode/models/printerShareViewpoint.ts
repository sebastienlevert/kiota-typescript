...
export class PrinterShareViewpoint implements AdditionalDataHolder, Parsable {
    ...
    private _lastUsedDateTime?: Date | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "lastUsedDateTime": n => { this.lastUsedDateTime = n.getDateValue(); },
        };
    };
    /**
     ...
     */
    public set lastUsedDateTime(value: Date | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeDateValue("lastUsedDateTime", this.lastUsedDateTime);
