...
export function serializeWindowsInformationProtectionPolicy(writer: SerializationWriter, windowsInformationProtectionPolicy: WindowsInformationProtectionPolicy | undefined = {}) : void {
