...
export class Subscription extends Entity implements Parsable {
    ...
    private _notificationContentType?: string | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "notificationContentType": n => { this.notificationContentType = n.getStringValue(); },
     ...
     * @returns a string
     */
    public get notificationContentType() {
     ...
     */
    public set notificationContentType(value: string | undefined) {
