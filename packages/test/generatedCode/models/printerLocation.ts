...
export class PrinterLocation implements AdditionalDataHolder, Parsable {
    ...
    private _roomNumber?: number | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "roomNumber": n => { this.roomNumber = n.getNumberValue(); },
     ...
     */
    public set roomNumber(value: number | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeNumberValue("roomNumber", this.roomNumber);
