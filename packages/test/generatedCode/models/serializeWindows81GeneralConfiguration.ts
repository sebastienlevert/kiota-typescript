...
export function serializeWindows81GeneralConfiguration(writer: SerializationWriter, windows81GeneralConfiguration: Windows81GeneralConfiguration | undefined = {}) : void {
        serializeDeviceConfiguration(writer, windows81GeneralConfiguration)
            ...
            writer.writeBooleanValue("applyOnlyToWindows81", windows81GeneralConfiguration.applyOnlyToWindows81);
