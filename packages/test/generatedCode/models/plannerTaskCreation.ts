import {createPlannerTeamsPublicationInfoFromDiscriminatorValue} from './createPlannerTeamsPublicationInfoFromDiscriminatorValue';
...
export class PlannerTaskCreation implements AdditionalDataHolder, Parsable {
    ...
    private _teamsPublicationInfo?: PlannerTeamsPublicationInfo | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "teamsPublicationInfo": n => { this.teamsPublicationInfo = n.getObjectValue<PlannerTeamsPublicationInfo>(createPlannerTeamsPublicationInfoFromDiscriminatorValue); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<PlannerTeamsPublicationInfo>("teamsPublicationInfo", this.teamsPublicationInfo);
        writer.writeAdditionalData(this.additionalData);
    };
    /**
     * Gets the teamsPublicationInfo property value. The teamsPublicationInfo property
     * @returns a plannerTeamsPublicationInfo
     */
    public get teamsPublicationInfo() {
        return this._teamsPublicationInfo;
    };
    /**
     * Sets the teamsPublicationInfo property value. The teamsPublicationInfo property
     * @param value Value to set for the teamsPublicationInfo property.
     */
    public set teamsPublicationInfo(value: PlannerTeamsPublicationInfo | undefined) {
