...
export class ManagedAppRegistration extends Entity implements Parsable {
    ...
    private _deviceManufacturer?: string | undefined;
     ...
     */
    public set deviceManufacturer(value: string | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "deviceManufacturer": n => { this.deviceManufacturer = n.getStringValue(); },
