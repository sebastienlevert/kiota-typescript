...
export class DeviceEnrollmentConfiguration extends Entity implements Parsable {
    ...
    private _deviceEnrollmentConfigurationType?: DeviceEnrollmentConfigurationType | undefined;
     ...
     * @returns a deviceEnrollmentConfigurationType
     */
    public get deviceEnrollmentConfigurationType() {
     ...
     */
    public set deviceEnrollmentConfigurationType(value: DeviceEnrollmentConfigurationType | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "deviceEnrollmentConfigurationType": n => { this.deviceEnrollmentConfigurationType = n.getEnumValue<DeviceEnrollmentConfigurationType>(DeviceEnrollmentConfigurationType); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeEnumValue<DeviceEnrollmentConfigurationType>("deviceEnrollmentConfigurationType", this.deviceEnrollmentConfigurationType);
