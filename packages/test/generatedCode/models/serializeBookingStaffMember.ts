...
export function serializeBookingStaffMember(writer: SerializationWriter, bookingStaffMember: BookingStaffMember | undefined = {}) : void {
        serializeBookingStaffMemberBase(writer, bookingStaffMember)
            ...
            writer.writeCollectionOfObjectValuesFromMethod("workingHours", bookingStaffMember.workingHours as any, serializeBookingWorkHours);
}
