...
export class AccessReviewNotificationRecipientItem implements AdditionalDataHolder, Parsable {
    ...
    /**
     * Gets the notificationRecipientScope property value. The notificationRecipientScope property
    ...
    /**
     * Sets the notificationRecipientScope property value. The notificationRecipientScope property
