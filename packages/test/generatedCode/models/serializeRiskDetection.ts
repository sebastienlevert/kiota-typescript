...
export function serializeRiskDetection(writer: SerializationWriter, riskDetection: RiskDetection | undefined = {}) : void {
        serializeEntity(writer, riskDetection)
            ...
            writer.writeObjectValueFromMethod("location", riskDetection.location as any, serializeSignInLocation);
