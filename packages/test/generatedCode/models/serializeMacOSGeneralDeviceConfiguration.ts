...
export function serializeMacOSGeneralDeviceConfiguration(writer: SerializationWriter, macOSGeneralDeviceConfiguration: MacOSGeneralDeviceConfiguration | undefined = {}) : void {
        serializeDeviceConfiguration(writer, macOSGeneralDeviceConfiguration)
            ...
            writer.writeCollectionOfObjectValuesFromMethod("compliantAppsList", macOSGeneralDeviceConfiguration.compliantAppsList as any, serializeAppListItem);
