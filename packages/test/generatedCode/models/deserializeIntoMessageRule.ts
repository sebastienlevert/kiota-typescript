...
export function deserializeIntoMessageRule(messageRule: MessageRule | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "actions": n => { messageRule.actions = n.getObjectValue(deserializeIntoMessageRuleActions) as any ; },
        "conditions": n => { messageRule.conditions = n.getObjectValue(deserializeIntoMessageRulePredicates) as any ; },
        "displayName": n => { messageRule.displayName = n.getStringValue() as any ; },
        "exceptions": n => { messageRule.exceptions = n.getObjectValue(deserializeIntoMessageRulePredicates) as any ; },
