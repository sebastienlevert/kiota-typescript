...
import {createUserConfigurationFromDiscriminatorValue} from './createUserConfigurationFromDiscriminatorValue';
...
export class MailFolder extends Entity implements Parsable {
    ...
    private _userConfigurations?: UserConfiguration[] | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "userConfigurations": n => { this.userConfigurations = n.getCollectionOfObjectValues<UserConfiguration>(createUserConfigurationFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<UserConfiguration>("userConfigurations", this.userConfigurations);
     ...
     */
    public set userConfigurations(value: UserConfiguration[] | undefined) {
        this._userConfigurations = value;
    };
    /**
