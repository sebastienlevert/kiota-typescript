...
import {createManagedDeviceMobileAppConfigurationSettingStateFromDiscriminatorValue} from './createManagedDeviceMobileAppConfigurationSettingStateFromDiscriminatorValue';
...
export class ManagedDeviceMobileAppConfigurationState extends Entity implements Parsable {
    ...
    private _settingStates?: ManagedDeviceMobileAppConfigurationSettingState[] | undefined;
    /** The state property */
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "settingStates": n => { this.settingStates = n.getCollectionOfObjectValues<ManagedDeviceMobileAppConfigurationSettingState>(createManagedDeviceMobileAppConfigurationSettingStateFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<ManagedDeviceMobileAppConfigurationSettingState>("settingStates", this.settingStates);
     ...
     * @returns a managedDeviceMobileAppConfigurationSettingState
     */
     ...
     */
    public set settingStates(value: ManagedDeviceMobileAppConfigurationSettingState[] | undefined) {
