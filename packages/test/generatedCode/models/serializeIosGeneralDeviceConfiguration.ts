...
export function serializeIosGeneralDeviceConfiguration(writer: SerializationWriter, iosGeneralDeviceConfiguration: IosGeneralDeviceConfiguration | undefined = {}) : void {
        serializeDeviceConfiguration(writer, iosGeneralDeviceConfiguration)
            ...
            writer.writeCollectionOfObjectValuesFromMethod("appsSingleAppModeList", iosGeneralDeviceConfiguration.appsSingleAppModeList as any, serializeAppListItem);
            ...
            writer.writeCollectionOfObjectValuesFromMethod("appsVisibilityList", iosGeneralDeviceConfiguration.appsVisibilityList as any, serializeAppListItem);
            ...
            writer.writeCollectionOfObjectValuesFromMethod("compliantAppsList", iosGeneralDeviceConfiguration.compliantAppsList as any, serializeAppListItem);
            ...
            writer.writeObjectValueFromMethod("mediaContentRatingAustralia", iosGeneralDeviceConfiguration.mediaContentRatingAustralia as any, serializeMediaContentRatingAustralia);
            writer.writeObjectValueFromMethod("mediaContentRatingCanada", iosGeneralDeviceConfiguration.mediaContentRatingCanada as any, serializeMediaContentRatingCanada);
            writer.writeObjectValueFromMethod("mediaContentRatingFrance", iosGeneralDeviceConfiguration.mediaContentRatingFrance as any, serializeMediaContentRatingFrance);
            writer.writeObjectValueFromMethod("mediaContentRatingGermany", iosGeneralDeviceConfiguration.mediaContentRatingGermany as any, serializeMediaContentRatingGermany);
            writer.writeObjectValueFromMethod("mediaContentRatingIreland", iosGeneralDeviceConfiguration.mediaContentRatingIreland as any, serializeMediaContentRatingIreland);
            writer.writeObjectValueFromMethod("mediaContentRatingJapan", iosGeneralDeviceConfiguration.mediaContentRatingJapan as any, serializeMediaContentRatingJapan);
            writer.writeObjectValueFromMethod("mediaContentRatingNewZealand", iosGeneralDeviceConfiguration.mediaContentRatingNewZealand as any, serializeMediaContentRatingNewZealand);
            writer.writeObjectValueFromMethod("mediaContentRatingUnitedKingdom", iosGeneralDeviceConfiguration.mediaContentRatingUnitedKingdom as any, serializeMediaContentRatingUnitedKingdom);
            writer.writeObjectValueFromMethod("mediaContentRatingUnitedStates", iosGeneralDeviceConfiguration.mediaContentRatingUnitedStates as any, serializeMediaContentRatingUnitedStates);
            writer.writeBooleanValue("messagesBlocked", iosGeneralDeviceConfiguration.messagesBlocked);
            writer.writeCollectionOfObjectValuesFromMethod("networkUsageRules", iosGeneralDeviceConfiguration.networkUsageRules as any, serializeIosNetworkUsageRule);
