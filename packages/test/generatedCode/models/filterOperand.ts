...
export class FilterOperand implements AdditionalDataHolder, Parsable {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "values": n => { this.values = n.getCollectionOfPrimitiveValues<string>(); },
        };
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfPrimitiveValues<string>("values", this.values);
