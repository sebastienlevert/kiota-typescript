...
export class SharingLink implements AdditionalDataHolder, Parsable {
    ...
    private _configuratorUrl?: string | undefined;
     ...
     */
    public set configuratorUrl(value: string | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "configuratorUrl": n => { this.configuratorUrl = n.getStringValue(); },
