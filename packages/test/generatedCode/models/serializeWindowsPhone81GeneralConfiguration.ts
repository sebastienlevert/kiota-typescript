...
export function serializeWindowsPhone81GeneralConfiguration(writer: SerializationWriter, windowsPhone81GeneralConfiguration: WindowsPhone81GeneralConfiguration | undefined = {}) : void {
        serializeDeviceConfiguration(writer, windowsPhone81GeneralConfiguration)
            writer.writeBooleanValue("applyOnlyToWindowsPhone81", windowsPhone81GeneralConfiguration.applyOnlyToWindowsPhone81);
            ...
            writer.writeCollectionOfObjectValuesFromMethod("compliantAppsList", windowsPhone81GeneralConfiguration.compliantAppsList as any, serializeAppListItem);
