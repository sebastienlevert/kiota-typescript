...
import {createPersonDataSourceFromDiscriminatorValue} from './createPersonDataSourceFromDiscriminatorValue';
import {createPhoneFromDiscriminatorValue} from './createPhoneFromDiscriminatorValue';
import {createRankedEmailAddressFromDiscriminatorValue} from './createRankedEmailAddressFromDiscriminatorValue';
...
export class Person extends Entity implements Parsable {
    ...
    private _emailAddresses?: RankedEmailAddress[] | undefined;
    ...
    private _mailboxType?: string | undefined;
    ...
    private _personType?: string | undefined;
    ...
    private _sources?: PersonDataSource[] | undefined;
     ...
     */
    public set emailAddresses(value: RankedEmailAddress[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "emailAddresses": n => { this.emailAddresses = n.getCollectionOfObjectValues<RankedEmailAddress>(createRankedEmailAddressFromDiscriminatorValue); },
            "givenName": n => { this.givenName = n.getStringValue(); },
            "isFavorite": n => { this.isFavorite = n.getBooleanValue(); },
            "mailboxType": n => { this.mailboxType = n.getStringValue(); },
            "officeLocation": n => { this.officeLocation = n.getStringValue(); },
            "personNotes": n => { this.personNotes = n.getStringValue(); },
            "personType": n => { this.personType = n.getStringValue(); },
            ...
            "sources": n => { this.sources = n.getCollectionOfObjectValues<PersonDataSource>(createPersonDataSourceFromDiscriminatorValue); },
     ...
     */
    public set mailboxType(value: string | undefined) {
     ...
     */
    public set personType(value: string | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<RankedEmailAddress>("emailAddresses", this.emailAddresses);
        ...
        writer.writeCollectionOfObjectValues<PersonDataSource>("sources", this.sources);
     ...
     */
    public set sources(value: PersonDataSource[] | undefined) {
        this._sources = value;
    };
    /**
