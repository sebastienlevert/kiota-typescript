...
export class ManagedDeviceMobileAppConfigurationSettingState implements AdditionalDataHolder, Parsable {
    ...
    /** SettingInstanceId */
    private _settingInstanceId?: string | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "settingInstanceId": n => { this.settingInstanceId = n.getStringValue(); },
     ...
     */
    public set settingInstanceId(value: string | undefined) {
