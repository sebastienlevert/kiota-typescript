...
export class AccessReviewStageSettings implements AdditionalDataHolder, Parsable {
    ...
    private _recommendationInsightSettings?: AccessReviewRecommendationInsightSetting[] | undefined;
    ...
    private _recommendationLookBackDuration?: Duration | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "recommendationInsightSettings": n => { this.recommendationInsightSettings = n.getCollectionOfObjectValues<AccessReviewRecommendationInsightSetting>(createAccessReviewRecommendationInsightSettingFromDiscriminatorValue); },
            "recommendationLookBackDuration": n => { this.recommendationLookBackDuration = n.getDurationValue(); },
     ...
     * @returns a accessReviewRecommendationInsightSetting
     */
    public get recommendationInsightSettings() {
     ...
     */
    public set recommendationInsightSettings(value: AccessReviewRecommendationInsightSetting[] | undefined) {
     ...
     * @returns a Duration
     */
    public get recommendationLookBackDuration() {
     ...
     */
    public set recommendationLookBackDuration(value: Duration | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AccessReviewRecommendationInsightSetting>("recommendationInsightSettings", this.recommendationInsightSettings);
        writer.writeDurationValue("recommendationLookBackDuration", this.recommendationLookBackDuration);
