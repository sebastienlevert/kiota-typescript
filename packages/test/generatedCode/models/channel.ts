...
import {createChannelModerationSettingsFromDiscriminatorValue} from './createChannelModerationSettingsFromDiscriminatorValue';
import {createChannelSummaryFromDiscriminatorValue} from './createChannelSummaryFromDiscriminatorValue';
...
export class Channel extends Entity implements Parsable {
    ...
    private _moderationSettings?: ChannelModerationSettings | undefined;
    /** A collection of teams with which a channel is shared. */
    private _sharedWithTeams?: SharedWithChannelTeamInfo[] | undefined;
    /** The summary property */
    private _summary?: ChannelSummary | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "moderationSettings": n => { this.moderationSettings = n.getObjectValue<ChannelModerationSettings>(createChannelModerationSettingsFromDiscriminatorValue); },
            ...
            "summary": n => { this.summary = n.getObjectValue<ChannelSummary>(createChannelSummaryFromDiscriminatorValue); },
    ...
    /**
     * Gets the moderationSettings property value. The moderationSettings property
     * @returns a channelModerationSettings
     */
    public get moderationSettings() {
        return this._moderationSettings;
    };
    /**
     * Sets the moderationSettings property value. The moderationSettings property
     * @param value Value to set for the moderationSettings property.
     */
    public set moderationSettings(value: ChannelModerationSettings | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<ChannelModerationSettings>("moderationSettings", this.moderationSettings);
        writer.writeCollectionOfObjectValues<SharedWithChannelTeamInfo>("sharedWithTeams", this.sharedWithTeams);
        writer.writeObjectValue<ChannelSummary>("summary", this.summary);
     ...
     */
    public set summary(value: ChannelSummary | undefined) {
        this._summary = value;
    };
    /**
