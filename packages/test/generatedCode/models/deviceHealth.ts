...
export class DeviceHealth implements AdditionalDataHolder, Parsable {
    /** Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well. */
    private _additionalData: Record<string, unknown>;
    /** The last time the device was connected. */
    private _lastConnectionTime?: Date | undefined;
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            "lastConnectionTime": n => { this.lastConnectionTime = n.getDateValue(); },
        };
    };
    /**
     ...
     */
    public set lastConnectionTime(value: Date | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeDateValue("lastConnectionTime", this.lastConnectionTime);
