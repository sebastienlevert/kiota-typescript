...
interface Guid{}
export class AppRoleAssignment extends Entity implements Parsable {
    ...
    private _creationTimestamp?: Date | undefined;
     ...
     */
    public set creationTimestamp(value: Date | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "creationTimestamp": n => { this.creationTimestamp = n.getDateValue(); },
    ...
    public serialize(writer: SerializationWriter) : void {
       ...
       // //writer.writeGuidValue("appRoleId", this.appRoleId);
        writer.writeDateValue("creationTimestamp", this.creationTimestamp);
