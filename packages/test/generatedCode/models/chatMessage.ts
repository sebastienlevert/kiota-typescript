...
export class ChatMessage extends Entity implements Parsable {
    ...
    private _onBehalfOf?: ChatMessageFromIdentitySet | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "onBehalfOf": n => { this.onBehalfOf = n.getObjectValue<ChatMessageFromIdentitySet>(createChatMessageFromIdentitySetFromDiscriminatorValue); },
    ...
    /**
     * Gets the onBehalfOf property value. The onBehalfOf property
     * @returns a chatMessageFromIdentitySet
     */
    ...
    /**
     * Sets the onBehalfOf property value. The onBehalfOf property
     * @param value Value to set for the onBehalfOf property.
     */
    public set onBehalfOf(value: ChatMessageFromIdentitySet | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<ChatMessageFromIdentitySet>("onBehalfOf", this.onBehalfOf);
