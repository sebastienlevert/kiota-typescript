...
export function serializePermissionGrantConditionSet(writer: SerializationWriter, permissionGrantConditionSet: PermissionGrantConditionSet | undefined = {}) : void {
