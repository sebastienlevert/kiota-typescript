...
import {createTimeCardFromDiscriminatorValue} from './createTimeCardFromDiscriminatorValue';
import {createTimeClockSettingsFromDiscriminatorValue} from './createTimeClockSettingsFromDiscriminatorValue';
...
export class Schedule extends Entity implements Parsable {
    ...
    private _timeCards?: TimeCard[] | undefined;
    /** Indicates whether time clock is enabled for the schedule. */
    private _timeClockEnabled?: boolean | undefined;
    /** The timeClockSettings property */
    private _timeClockSettings?: TimeClockSettings | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "timeCards": n => { this.timeCards = n.getCollectionOfObjectValues<TimeCard>(createTimeCardFromDiscriminatorValue); },
            "timeClockEnabled": n => { this.timeClockEnabled = n.getBooleanValue(); },
            "timeClockSettings": n => { this.timeClockSettings = n.getObjectValue<TimeClockSettings>(createTimeClockSettingsFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<TimeCard>("timeCards", this.timeCards);
        writer.writeBooleanValue("timeClockEnabled", this.timeClockEnabled);
        writer.writeObjectValue<TimeClockSettings>("timeClockSettings", this.timeClockSettings);
     ...
     */
    public set timeCards(value: TimeCard[] | undefined) {
     ...
     * @returns a timeClockSettings
     */
    public get timeClockSettings() {
     ...
     */
    public set timeClockSettings(value: TimeClockSettings | undefined) {
