...
export function serializeWindows10TeamGeneralConfiguration(writer: SerializationWriter, windows10TeamGeneralConfiguration: Windows10TeamGeneralConfiguration | undefined = {}) : void {
