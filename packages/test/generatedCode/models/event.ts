...
export class Event extends OutlookItem implements Parsable {
    ...
    private _cancelledOccurrences?: string[] | undefined;
    /** The end property */
    private _end?: DateTimeTimeZone | undefined;
    /** The exceptionOccurrences property */
    private _exceptionOccurrences?: Event[] | undefined;
    ...
    private _occurrenceId?: string | undefined;
     ...
     * @returns a string
     */
    public get cancelledOccurrences() {
     ...
     */
    public set cancelledOccurrences(value: string[] | undefined) {
     ...
     * @returns a event
     */
    public get exceptionOccurrences() {
     ...
     */
    public set exceptionOccurrences(value: Event[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "cancelledOccurrences": n => { this.cancelledOccurrences = n.getCollectionOfPrimitiveValues<string>(); },
            "end": n => { this.end = n.getObjectValue<DateTimeTimeZone>(createDateTimeTimeZoneFromDiscriminatorValue); },
            "exceptionOccurrences": n => { this.exceptionOccurrences = n.getCollectionOfObjectValues<Event>(createEventFromDiscriminatorValue); },
            ...
            "occurrenceId": n => { this.occurrenceId = n.getStringValue(); },
            ...
            "uid": n => { this.uid = n.getStringValue(); },
     ...
     */
    public set occurrenceId(value: string | undefined) {
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfPrimitiveValues<string>("cancelledOccurrences", this.cancelledOccurrences);
        writer.writeObjectValue<DateTimeTimeZone>("end", this.end);
        writer.writeCollectionOfObjectValues<Event>("exceptionOccurrences", this.exceptionOccurrences);
