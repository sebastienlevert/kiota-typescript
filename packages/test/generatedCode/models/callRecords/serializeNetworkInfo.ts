...
export function serializeNetworkInfo(writer: SerializationWriter, networkInfo: NetworkInfo | undefined = {}) : void {
            ...
            writer.writeCollectionOfObjectValuesFromMethod("traceRouteHops", networkInfo.traceRouteHops as any, serializeTraceRouteHop);
