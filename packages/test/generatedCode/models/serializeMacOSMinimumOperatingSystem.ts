...
export function serializeMacOSMinimumOperatingSystem(writer: SerializationWriter, macOSMinimumOperatingSystem: MacOSMinimumOperatingSystem | undefined = {}) : void {
