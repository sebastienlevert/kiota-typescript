...
import {createPlannerTaskCreationFromDiscriminatorValue} from './createPlannerTaskCreationFromDiscriminatorValue';
...
export class PlannerTask extends PlannerDelta implements Parsable {
    ...
    private _creationSource?: PlannerTaskCreation | undefined;
     ...
     */
    public set creationSource(value: PlannerTaskCreation | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "creationSource": n => { this.creationSource = n.getObjectValue<PlannerTaskCreation>(createPlannerTaskCreationFromDiscriminatorValue); },
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<PlannerTaskCreation>("creationSource", this.creationSource);
