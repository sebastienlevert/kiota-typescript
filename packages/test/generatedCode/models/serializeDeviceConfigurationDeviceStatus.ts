...
export function serializeDeviceConfigurationDeviceStatus(writer: SerializationWriter, deviceConfigurationDeviceStatus: DeviceConfigurationDeviceStatus | undefined = {}) : void {
