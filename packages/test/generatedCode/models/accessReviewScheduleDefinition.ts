...
export class AccessReviewScheduleDefinition extends Entity implements Parsable {
    ...
    private _backupReviewers?: AccessReviewReviewerScope[] | undefined;
     ...
     */
    public set backupReviewers(value: AccessReviewReviewerScope[] | undefined) {
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {...super.getFieldDeserializers(),
            ...
            "backupReviewers": n => { this.backupReviewers = n.getCollectionOfObjectValues<AccessReviewReviewerScope>(createAccessReviewReviewerScopeFromDiscriminatorValue); },
    ...
    /**
     * Gets the instanceEnumerationScope property value. The instanceEnumerationScope property
    ...
    /**
     * Sets the instanceEnumerationScope property value. The instanceEnumerationScope property
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfObjectValues<AccessReviewReviewerScope>("backupReviewers", this.backupReviewers);
