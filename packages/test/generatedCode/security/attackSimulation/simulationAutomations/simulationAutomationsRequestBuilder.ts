...
import {deserializeIntoSimulationAutomationCollectionResponse} from '../../../models/deserializeIntoSimulationAutomationCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeSimulationAutomation} from '../../../models/serializeSimulationAutomation';
import {serializeSimulationAutomationCollectionResponse} from '../../../models/serializeSimulationAutomationCollectionResponse';
import {SimulationAutomation} from '../../../models/simulationAutomation';
import {SimulationAutomationCollectionResponse} from '../../../models/simulationAutomationCollectionResponse';
...
export class SimulationAutomationsRequestBuilder {
    ...
    public get(requestConfiguration?: SimulationAutomationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SimulationAutomationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SimulationAutomationCollectionResponse>(requestInfo,deserializeIntoSimulationAutomationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to simulationAutomations for security
     * @param body 
    ...
    public post(body: SimulationAutomation | undefined, requestConfiguration?: SimulationAutomationsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SimulationAutomation | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SimulationAutomation>(requestInfo,deserializeIntoSimulationAutomation, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
