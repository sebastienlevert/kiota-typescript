...
import {deserializeIntoSiteSourceCollectionResponse} from '../../../../../../../models/security/deserializeIntoSiteSourceCollectionResponse';
import {serializeSiteSource} from '../../../../../../../models/security/serializeSiteSource';
import {serializeSiteSourceCollectionResponse} from '../../../../../../../models/security/serializeSiteSourceCollectionResponse';
import {SiteSource} from '../../../../../../../models/security/siteSource';
import {SiteSourceCollectionResponse} from '../../../../../../../models/security/siteSourceCollectionResponse';
...
export class SiteSourcesRequestBuilder {
    ...
    public get(requestConfiguration?: SiteSourcesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SiteSourceCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SiteSourceCollectionResponse>(requestInfo,deserializeIntoSiteSourceCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new siteSource object associated with an eDiscovery custodian.
     * @param body 
    ...
    public post(body: SiteSource | undefined, requestConfiguration?: SiteSourcesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<SiteSource | undefined> {
        ...
        return this.requestAdapter?.sendAsync<SiteSource>(requestInfo,deserializeIntoSiteSource, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
