...
import {CaseOperationCollectionResponse} from '../../../../../models/security/caseOperationCollectionResponse';
import {deserializeIntoCaseOperation} from '../../../../../models/security/deserializeIntoCaseOperation';
import {deserializeIntoCaseOperationCollectionResponse} from '../../../../../models/security/deserializeIntoCaseOperationCollectionResponse';
import {serializeCaseOperation} from '../../../../../models/security/serializeCaseOperation';
import {serializeCaseOperationCollectionResponse} from '../../../../../models/security/serializeCaseOperationCollectionResponse';
...
export class OperationsRequestBuilder {
    ...
    public get(requestConfiguration?: OperationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CaseOperationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CaseOperationCollectionResponse>(requestInfo,deserializeIntoCaseOperationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to operations for security
     * @param body 
    ...
    public post(body: CaseOperation | undefined, requestConfiguration?: OperationsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CaseOperation | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CaseOperation>(requestInfo,deserializeIntoCaseOperation, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
