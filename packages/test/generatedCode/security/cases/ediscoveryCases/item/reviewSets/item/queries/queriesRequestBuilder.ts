...
import {deserializeIntoEdiscoveryReviewSetQueryCollectionResponse} from '../../../../../../../models/security/deserializeIntoEdiscoveryReviewSetQueryCollectionResponse';
import {EdiscoveryReviewSetQuery} from '../../../../../../../models/security/ediscoveryReviewSetQuery';
import {EdiscoveryReviewSetQueryCollectionResponse} from '../../../../../../../models/security/ediscoveryReviewSetQueryCollectionResponse';
import {serializeEdiscoveryReviewSetQuery} from '../../../../../../../models/security/serializeEdiscoveryReviewSetQuery';
import {serializeEdiscoveryReviewSetQueryCollectionResponse} from '../../../../../../../models/security/serializeEdiscoveryReviewSetQueryCollectionResponse';
...
export class QueriesRequestBuilder {
    ...
    public get(requestConfiguration?: QueriesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EdiscoveryReviewSetQueryCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EdiscoveryReviewSetQueryCollectionResponse>(requestInfo,deserializeIntoEdiscoveryReviewSetQueryCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new ediscoveryReviewSetQuery object.
     * @param body 
