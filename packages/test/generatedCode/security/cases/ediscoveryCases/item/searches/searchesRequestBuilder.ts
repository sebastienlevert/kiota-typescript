...
import {deserializeIntoEdiscoverySearchCollectionResponse} from '../../../../../models/security/deserializeIntoEdiscoverySearchCollectionResponse';
import {EdiscoverySearch} from '../../../../../models/security/ediscoverySearch';
import {EdiscoverySearchCollectionResponse} from '../../../../../models/security/ediscoverySearchCollectionResponse';
import {serializeEdiscoverySearch} from '../../../../../models/security/serializeEdiscoverySearch';
import {serializeEdiscoverySearchCollectionResponse} from '../../../../../models/security/serializeEdiscoverySearchCollectionResponse';
...
export class SearchesRequestBuilder {
    ...
    public get(requestConfiguration?: SearchesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EdiscoverySearchCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EdiscoverySearchCollectionResponse>(requestInfo,deserializeIntoEdiscoverySearchCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new ediscoverySearch object.
     * @param body 
