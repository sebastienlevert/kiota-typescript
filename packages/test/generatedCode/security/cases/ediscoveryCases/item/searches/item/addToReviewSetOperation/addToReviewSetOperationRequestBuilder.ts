...
import {deserializeIntoEdiscoveryAddToReviewSetOperation} from '../../../../../../../models/security/deserializeIntoEdiscoveryAddToReviewSetOperation';
import {EdiscoveryAddToReviewSetOperation} from '../../../../../../../models/security/ediscoveryAddToReviewSetOperation';
import {serializeEdiscoveryAddToReviewSetOperation} from '../../../../../../../models/security/serializeEdiscoveryAddToReviewSetOperation';
...
export class AddToReviewSetOperationRequestBuilder {
    ...
    public get(requestConfiguration?: AddToReviewSetOperationRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EdiscoveryAddToReviewSetOperation | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EdiscoveryAddToReviewSetOperation>(requestInfo,deserializeIntoEdiscoveryAddToReviewSetOperation, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
