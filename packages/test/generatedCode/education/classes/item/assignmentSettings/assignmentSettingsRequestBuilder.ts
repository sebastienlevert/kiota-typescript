...
export class AssignmentSettingsRequestBuilder {
    ...
    public get(requestConfiguration?: AssignmentSettingsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignmentSettings | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationAssignmentSettings>(requestInfo,deserializeIntoEducationAssignmentSettings, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the properties of an educationAssignmentSettings object. Only Teachers can update these settings.
     * @param body 
