...
import {EducationSubmissionResourceItemRequestBuilder as ia4c3b13f258d2cc263c1d6a1ebf26c4ea06a24da70a806430340d5b96f3b6f21} from './resources/item/educationSubmissionResourceItemRequestBuilder';
...
import {EducationSubmissionResourceItemRequestBuilder as i8c0c948bb2566908e37131b959028fb0c8fbc0f3d600750b45929d07f6f6dd6a} from './submittedResources/item/educationSubmissionResourceItemRequestBuilder';
...
export class EducationSubmissionItemRequestBuilder {
     ...
     */
    public resourcesById(id: string) : ia4c3b13f258d2cc263c1d6a1ebf26c4ea06a24da70a806430340d5b96f3b6f21 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource%2Did"] = id
        return new ia4c3b13f258d2cc263c1d6a1ebf26c4ea06a24da70a806430340d5b96f3b6f21(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the submittedResources property of the microsoft.graph.educationSubmission entity.
     * @param id Unique identifier of the item
     * @returns a EducationSubmissionResourceItemRequestBuilder
     */
    public submittedResourcesById(id: string) : i8c0c948bb2566908e37131b959028fb0c8fbc0f3d600750b45929d07f6f6dd6a {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource%2Did"] = id
        return new i8c0c948bb2566908e37131b959028fb0c8fbc0f3d600750b45929d07f6f6dd6a(urlTplParams, this.requestAdapter);
    };
}
