...
import {EducationSubmissionResourceItemRequestBuilder as iadeb6611064f3a7702aca028a50f0e92f667bd0d93a034a2f6394c40d6284949} from './resources/item/educationSubmissionResourceItemRequestBuilder';
...
import {EducationSubmissionResourceItemRequestBuilder as i1887d8fd36a5b1bfe9cf75a0bdb01af9800a5493c642348036725d9ddbf7434b} from './submittedResources/item/educationSubmissionResourceItemRequestBuilder';
...
export class EducationSubmissionItemRequestBuilder {
     ...
     */
    public resourcesById(id: string) : iadeb6611064f3a7702aca028a50f0e92f667bd0d93a034a2f6394c40d6284949 {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource%2Did"] = id
        return new iadeb6611064f3a7702aca028a50f0e92f667bd0d93a034a2f6394c40d6284949(urlTplParams, this.requestAdapter);
    };
    /**
     * Provides operations to manage the submittedResources property of the microsoft.graph.educationSubmission entity.
     * @param id Unique identifier of the item
     * @returns a EducationSubmissionResourceItemRequestBuilder
     */
    public submittedResourcesById(id: string) : i1887d8fd36a5b1bfe9cf75a0bdb01af9800a5493c642348036725d9ddbf7434b {
        if(!id) throw new Error("id cannot be undefined");
        const urlTplParams = getPathParameters(this.pathParameters);
        urlTplParams["educationSubmissionResource%2Did"] = id
        return new i1887d8fd36a5b1bfe9cf75a0bdb01af9800a5493c642348036725d9ddbf7434b(urlTplParams, this.requestAdapter);
    };
}
