...
import {deserializeIntoEducationAssignmentResourceCollectionResponse} from '../../../../../../models/deserializeIntoEducationAssignmentResourceCollectionResponse';
...
import {serializeEducationAssignmentResourceCollectionResponse} from '../../../../../../models/serializeEducationAssignmentResourceCollectionResponse';
...
export class ResourcesRequestBuilder {
    ...
    public get(requestConfiguration?: ResourcesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignmentResourceCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationAssignmentResourceCollectionResponse>(requestInfo,deserializeIntoEducationAssignmentResourceCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create an assignment resource. You can create the following types of assignment resources: Every resource has an @odata.type property to indicate which type of resource is being created. 
     * @param body 
    ...
    public post(body: EducationAssignmentResource | undefined, requestConfiguration?: ResourcesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationAssignmentResource | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationAssignmentResource>(requestInfo,deserializeIntoEducationAssignmentResource, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
