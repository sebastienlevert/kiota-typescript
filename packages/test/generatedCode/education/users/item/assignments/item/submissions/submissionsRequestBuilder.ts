...
import {deserializeIntoEducationSubmissionCollectionResponse} from '../../../../../../models/deserializeIntoEducationSubmissionCollectionResponse';
...
import {serializeEducationSubmissionCollectionResponse} from '../../../../../../models/serializeEducationSubmissionCollectionResponse';
...
export class SubmissionsRequestBuilder {
    ...
    public get(requestConfiguration?: SubmissionsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EducationSubmissionCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EducationSubmissionCollectionResponse>(requestInfo,deserializeIntoEducationSubmissionCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to submissions for education
     * @param body 
