...
export class DefaultRequestBuilder {
    ...
    public get(requestConfiguration?: DefaultRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CrossTenantAccessPolicyConfigurationDefault | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CrossTenantAccessPolicyConfigurationDefault>(requestInfo,deserializeIntoCrossTenantAccessPolicyConfigurationDefault, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the default configuration of a cross-tenant access policy.
     * @param body 
