...
import {CrossTenantAccessPolicyConfigurationPartnerCollectionResponse} from '../../../models/crossTenantAccessPolicyConfigurationPartnerCollectionResponse';
...
import {deserializeIntoCrossTenantAccessPolicyConfigurationPartnerCollectionResponse} from '../../../models/deserializeIntoCrossTenantAccessPolicyConfigurationPartnerCollectionResponse';
...
import {serializeCrossTenantAccessPolicyConfigurationPartnerCollectionResponse} from '../../../models/serializeCrossTenantAccessPolicyConfigurationPartnerCollectionResponse';
...
export class PartnersRequestBuilder {
    ...
    public get(requestConfiguration?: PartnersRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CrossTenantAccessPolicyConfigurationPartnerCollectionResponse>(requestInfo,deserializeIntoCrossTenantAccessPolicyConfigurationPartnerCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new partner configuration in a cross-tenant access policy.
     * @param body 
    ...
    public post(body: CrossTenantAccessPolicyConfigurationPartner | undefined, requestConfiguration?: PartnersRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<CrossTenantAccessPolicyConfigurationPartner | undefined> {
        ...
        return this.requestAdapter?.sendAsync<CrossTenantAccessPolicyConfigurationPartner>(requestInfo,deserializeIntoCrossTenantAccessPolicyConfigurationPartner, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
