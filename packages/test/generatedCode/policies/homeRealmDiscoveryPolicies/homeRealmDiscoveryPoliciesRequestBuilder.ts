...
import {deserializeIntoHomeRealmDiscoveryPolicyCollectionResponse} from '../../models/deserializeIntoHomeRealmDiscoveryPolicyCollectionResponse';
...
import {serializeHomeRealmDiscoveryPolicyCollectionResponse} from '../../models/serializeHomeRealmDiscoveryPolicyCollectionResponse';
...
export class HomeRealmDiscoveryPoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: HomeRealmDiscoveryPoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<HomeRealmDiscoveryPolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<HomeRealmDiscoveryPolicyCollectionResponse>(requestInfo,deserializeIntoHomeRealmDiscoveryPolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new homeRealmDiscoveryPolicy object.
     * @param body 
    ...
    public post(body: HomeRealmDiscoveryPolicy | undefined, requestConfiguration?: HomeRealmDiscoveryPoliciesRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<HomeRealmDiscoveryPolicy | undefined> {
        ...
        return this.requestAdapter?.sendAsync<HomeRealmDiscoveryPolicy>(requestInfo,deserializeIntoHomeRealmDiscoveryPolicy, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
