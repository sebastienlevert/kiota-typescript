...
export class AdminConsentRequestPolicyRequestBuilder {
    ...
    public get(requestConfiguration?: AdminConsentRequestPolicyRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AdminConsentRequestPolicy | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AdminConsentRequestPolicy>(requestInfo,deserializeIntoAdminConsentRequestPolicy, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the properties of an adminConsentRequestPolicy object.
     * @param body 
