...
import {deserializeIntoFeatureRolloutPolicyCollectionResponse} from '../../models/deserializeIntoFeatureRolloutPolicyCollectionResponse';
...
import {serializeFeatureRolloutPolicyCollectionResponse} from '../../models/serializeFeatureRolloutPolicyCollectionResponse';
...
export class FeatureRolloutPoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: FeatureRolloutPoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<FeatureRolloutPolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<FeatureRolloutPolicyCollectionResponse>(requestInfo,deserializeIntoFeatureRolloutPolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create a new featureRolloutPolicy object.
     * @param body 
