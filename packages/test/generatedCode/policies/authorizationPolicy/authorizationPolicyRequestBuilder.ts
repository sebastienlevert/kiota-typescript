...
export class AuthorizationPolicyRequestBuilder {
    ...
    public get(requestConfiguration?: AuthorizationPolicyRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<AuthorizationPolicy | undefined> {
        ...
        return this.requestAdapter?.sendAsync<AuthorizationPolicy>(requestInfo,deserializeIntoAuthorizationPolicy, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Update the properties of an authorizationPolicy object.
     * @param body 
