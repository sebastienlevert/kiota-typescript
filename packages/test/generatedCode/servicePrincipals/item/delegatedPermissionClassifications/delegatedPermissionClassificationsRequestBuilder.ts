...
import {deserializeIntoDelegatedPermissionClassificationCollectionResponse} from '../../../models/deserializeIntoDelegatedPermissionClassificationCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeDelegatedPermissionClassification} from '../../../models/serializeDelegatedPermissionClassification';
import {serializeDelegatedPermissionClassificationCollectionResponse} from '../../../models/serializeDelegatedPermissionClassificationCollectionResponse';
...
export class DelegatedPermissionClassificationsRequestBuilder {
    ...
    public get(requestConfiguration?: DelegatedPermissionClassificationsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DelegatedPermissionClassificationCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DelegatedPermissionClassificationCollectionResponse>(requestInfo,deserializeIntoDelegatedPermissionClassificationCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Classify a delegated permission by adding a delegatedPermissionClassification to the servicePrincipal representing the API.
     * @param body 
    ...
    public post(body: DelegatedPermissionClassification | undefined, requestConfiguration?: DelegatedPermissionClassificationsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<DelegatedPermissionClassification | undefined> {
        ...
        return this.requestAdapter?.sendAsync<DelegatedPermissionClassification>(requestInfo,deserializeIntoDelegatedPermissionClassification, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
