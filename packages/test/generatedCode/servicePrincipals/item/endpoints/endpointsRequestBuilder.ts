...
import {deserializeIntoEndpointCollectionResponse} from '../../../models/deserializeIntoEndpointCollectionResponse';
...
import {serializeEndpointCollectionResponse} from '../../../models/serializeEndpointCollectionResponse';
...
export class EndpointsRequestBuilder {
    ...
    public get(requestConfiguration?: EndpointsRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<EndpointCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<EndpointCollectionResponse>(requestInfo,deserializeIntoEndpointCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
    /**
     * Create new navigation property to endpoints for servicePrincipals
     * @param body 
    ...
    public post(body: Endpoint | undefined, requestConfiguration?: EndpointsRequestBuilderPostRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Endpoint | undefined> {
        ...
        return this.requestAdapter?.sendAsync<Endpoint>(requestInfo,deserializeIntoEndpoint, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
