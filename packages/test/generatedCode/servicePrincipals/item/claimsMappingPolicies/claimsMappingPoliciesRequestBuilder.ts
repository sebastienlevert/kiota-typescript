...
import {deserializeIntoClaimsMappingPolicyCollectionResponse} from '../../../models/deserializeIntoClaimsMappingPolicyCollectionResponse';
import {ODataError} from '../../../models/oDataErrors/oDataError';
import {serializeClaimsMappingPolicyCollectionResponse} from '../../../models/serializeClaimsMappingPolicyCollectionResponse';
...
export class ClaimsMappingPoliciesRequestBuilder {
    ...
    public get(requestConfiguration?: ClaimsMappingPoliciesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<ClaimsMappingPolicyCollectionResponse | undefined> {
        ...
        return this.requestAdapter?.sendAsync<ClaimsMappingPolicyCollectionResponse>(requestInfo,deserializeIntoClaimsMappingPolicyCollectionResponse, responseHandler, {}) ?? Promise.reject(new Error('request adapter is null'));
    };
}
