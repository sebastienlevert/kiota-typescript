...
export class MessageRulePredicates {
    ...
    getFieldDeserializers() {
        return new Map([
            ...
            ["fromAddresses", (o, n) => { o.fromAddresses = n.getCollectionOfObjectValues(Recipient); }],
            ...
            ["sentToAddresses", (o, n) => { o.sentToAddresses = n.getCollectionOfObjectValues(Recipient); }],
