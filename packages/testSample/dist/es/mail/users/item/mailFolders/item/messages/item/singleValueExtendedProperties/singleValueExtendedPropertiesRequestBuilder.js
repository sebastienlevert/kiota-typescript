...
export class SingleValueExtendedPropertiesRequestBuilder {
    ...
    get(q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, SingleValueExtendedPropertiesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
    /**
     * The collection of single-value extended properties defined for the message. Nullable.
    ...
    post(body, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, SingleValueLegacyExtendedProperty, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
}
