...
export class MessagesRequestBuilder {
    ...
    get(q, h, o, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendAsync(requestInfo, MessagesResponse, responseHandler)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('http core is null'));
    }
    ;
    /**
     * The messages in a mailbox or folder. Read-only. Nullable.
