...
export declare class ExtensionsResponse implements Parsable {
     ...
     */
    set value(value: Extension[] | undefined);
}
//# sourceMappingURL=extensionsResponse.d.ts.map