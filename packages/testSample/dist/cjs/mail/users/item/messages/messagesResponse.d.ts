...
export declare class MessagesResponse implements Parsable {
     ...
     */
    set value(value: Message[] | undefined);
}
//# sourceMappingURL=messagesResponse.d.ts.map