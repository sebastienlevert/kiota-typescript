...
export declare class AttachmentsResponse implements Parsable {
     ...
     */
    get value(): Attachment[] | undefined;
    /**
     ...
     */
    set value(value: Attachment[] | undefined);
}
//# sourceMappingURL=attachmentsResponse.d.ts.map