...
exports.MessageRuleActions = void 0;
...
class MessageRuleActions {
    ...
    getFieldDeserializers() {
        return new Map([
            ...
            ["forwardAsAttachmentTo", (o, n) => { o.forwardAsAttachmentTo = n.getCollectionOfObjectValues(recipient_1.Recipient); }],
            ["forwardTo", (o, n) => { o.forwardTo = n.getCollectionOfObjectValues(recipient_1.Recipient); }],
            ["markAsRead", (o, n) => { o.markAsRead = n.getBooleanValue(); }],
            ["markImportance", (o, n) => { o.markImportance = n.getEnumValue(importance_1.Importance); }],
            ["moveToFolder", (o, n) => { o.moveToFolder = n.getStringValue(); }],
            ["permanentDelete", (o, n) => { o.permanentDelete = n.getBooleanValue(); }],
            ["redirectTo", (o, n) => { o.redirectTo = n.getCollectionOfObjectValues(recipient_1.Recipient); }],
...
exports.MessageRuleActions = MessageRuleActions;
