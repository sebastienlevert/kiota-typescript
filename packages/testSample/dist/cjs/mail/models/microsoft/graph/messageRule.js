...
const messageRuleActions_1 = require("./messageRuleActions");
const messageRulePredicates_1 = require("./messageRulePredicates");
class MessageRule extends entity_1.Entity {
    /**
    ...
    getFieldDeserializers() {
        return new Map([...super.getFieldDeserializers(),
            ["actions", (o, n) => { o.actions = n.getObjectValue(messageRuleActions_1.MessageRuleActions); }],
            ["conditions", (o, n) => { o.conditions = n.getObjectValue(messageRulePredicates_1.MessageRulePredicates); }],
            ["displayName", (o, n) => { o.displayName = n.getStringValue(); }],
            ["exceptions", (o, n) => { o.exceptions = n.getObjectValue(messageRulePredicates_1.MessageRulePredicates); }],
